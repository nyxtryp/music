...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function is(e,t,n){let r=new Float32Array(Wo),i=new K(0,1,0);return new _a({name:`SphericalGaussianBlur`,defines:{n:Wo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ss(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function as(){return new _a({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ss(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function os(){return new _a({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ss(),fragmentShader:`
	...
	`}var cs=class extends pn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ui(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Nc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Pc(e,t){let n=Nc[t];return n===void 0?(H(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Fc=new K;function Ic(){return J.getLuminanceCoefficients(Fc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Fc.x.toFixed(4)}, ${Fc.y.toFixed(4)}, ${Fc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
POINTS: `+i.points+`
WEBGL: `+(n?n.getParameter(n.VERSION):`UNKNOWN`);f.textContent=o;try{localStorage.setItem(`nyxtryp-webgl-diagnostic`,o)}catch(e){console.warn(`NYXTRYP diagnostic localStorage write failed`,e)}};d.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),he=!0,_=`WEBGL CONTEXT LOST`,cancelAnimationFrame(me),v(`!!! WEBGL CONTEXT LOST !!!`,`The browser/GPU lost the WebGL context.`)},!1),d.addEventListener(`webglcontextrestored`,()=>{he=!1,_=`WEBGL CONTEXT RESTORED`,v(`WEBGL CONTEXT RESTORED`,`WebGL context was restored by the browser.`),me=requestAnimationFrame(ge)},!1),window.addEventListener(`error`,e=>{_=`window error`,v(`JAVASCRIPT ERROR`,String(e?.message||e?.error||`unknown error`))}),window.addEventListener(`unhandledrejection`,e=>{_=`unhandled promise rejection`,v(`UNHANDLED PROMISE REJECTION`,String(e?.reason||`unknown rejection`))});let y=e=>{_=e};d.addEventListener(`pointerdown`,()=>y(`pointerdown`)),d.addEventListener(`wheel`,()=>y(`wheel / zoom`)),d.style.cursor=`default`,d.style.touchAction=`none`;let b=new so(9546188,.95);a.add(b);let x=new K(-35,18,-55),S=new oo(16777215,6.5);S.position.copy(x),S.target.position.set(0,0,-10),S.castShadow=!0,S.shadow.mapSize.width=o?1024:2048,S.shadow.mapSize.height=o?1024:2048,S.shadow.camera.near=1,S.shadow.camera.far=120,a.add(S),a.add(S.target);let C=new Wa(10206463,1120295,.85);a.add(C);let w=new X(new sa(.75,48,48),new ri({color:16774351,transparent:!0,opacity:0,depthWrite:!1}));w.position.copy(x),a.add(w);let T=new X(new sa(1.25,48,48),new ri({color:16767370,transparent:!0,opacity:0,depthWrite:!1,blending:2}));T.position.copy(x),a.add(T);let E=[],D=(e,t,n,r,i)=>{let o=new Float32Array(e*3);for(let n=0;n<e;n++)o[n*3]=(Math.random()-.5)*t,o[n*3+1]=(Math.random()-.5)*t,o[n*3+2]=-Math.random()*i;let s=new Kr;s.setAttribute(`position`,new jr(o,3));let c=new Vi(s,new Ii({color:16777215,size:n,transparent:!0,opacity:r,depthWrite:!1,sizeAttenuation:!0}));a.add(c),E.push({object:c,speed:15e-5+Math.random()*2e-4})};D(900,100,.035,.45,120),D(420,70,.055,.65,75),D(160,45,.085,.85,45);let O=[];for(let e=0;e<3;e++){let e=new Kr;e.setAttribute(`position`,new jr(new Float32Array([0,0,0,-.9,.25,0]),3));let t=new Pi(e,new Ei({color:16777215,transparent:!0,opacity:0}));t.position.set(0,0,-20),a.add(t),O.push({object:t,active:!1,timer:Math.random()*12+5,life:0})}let k=new Ha,A=[];ql.forEach((e,t)=>{let n=k.load(e.texture);n.colorSpace=rt,n.anisotropy=c?1:u.capabilities.getMaxAnisotropy();let r=new ya({map:n,roughness:e.atmosphere?.62:.72,metalness:0,envMapIntensity:1.15,emissive:e.atmosphere?new Y(16777215):new Y(0),emissiveMap:e.atmosphere?n:null,emissiveIntensity:e.atmosphere?.22:0}),o=new X(new sa(e.radius,64,64),r);o.position.set(...e.position),o.castShadow=!0,o.receiveShadow=!0,o.userData.name=e.name,o.userData.index=t,a.add(o);let s=new ro(10470655,2.2,e.radius*13,2);if(s.position.set(-e.radius*2.5,e.radius*1.5,e.radius*3),o.add(s),e.atmosphere){let t=new _a({transparent:!0,depthWrite:!1,depthTest:!0,side:1,blending:2,uniforms:{sunDirection:{value:new K(-3,2,5).normalize()},innerRadius:{value:e.radius},outerRadius:{value:e.radius*1.28}},vertexShader:`
      ...
      `}),n=new X(new sa(e.radius*1.075,c?64:128,c?64:128),t);o.add(n)}if(e.atmosphere){let t=new Wn;t.name=`AUDIO_MENU_SATELLITES_V1`,o.add(t);let n=new Wn;n.name=`TRACKS`;let r=new X(new sa(e.radius*.2,32,32),new ya({color:1381146,metalness:.72,roughness:.28,emissive:2365195,emissiveIntensity:.45}));n.add(r);let i=new X(new sa(e.radius*.42,16,16),new ri({transparent:!0,opacity:0,depthWrite:!1}));i.userData.isTracksHitArea=!0,n.add(i);let a=new X(new ca(e.radius*.3,e.radius*.018,12,64),new ri({color:16761917,transparent:!0,opacity:.95}));a.rotation.x=Math.PI*.48,n.add(a);for(let t=0;t<4;t++){let r=new X(new qi(e.radius*.3,e.radius*.014,e.radius*.018),new ri({color:16767078,transparent:!0,opacity:.8}));r.position.set(-e.radius*.05,(t-1.5)*e.radius*.065,e.radius*.2),r.rotation.z=(t-1.5)*.07,n.add(r)}n.position.set(-e.radius*2,0,0),t.add(n);let s=new Wn;s.name=`MIXES`;let c=new X(new sa(e.radius*.22,32,32),new ya({color:7421388,metalness:.55,roughness:.24,emissive:3412062,emissiveIntensity:.8}));s.add(c);let l=new ri({color:13671167,transparent:!0,opacity:.9}),u=new ri({color:9395455,transparent:!0,opacity:.8}),d=new X(new ca(e.radius*.34,e.radius*.015,12,64),l);d.rotation.x=Math.PI*.42,d.rotation.z=Math.PI*.18,s.add(d);let f=new X(new ca(e.radius*.34,e.radius*.013,12,64),u);f.rotation.x=-Math.PI*.42,f.rotation.z=-Math.PI*.22,s.add(f);for(let t=0;t<3;t++){let n=new X(new sa(e.radius*.035,16,16),new ri({color:15187455})),r=t*Math.PI*2/3;n.position.set(Math.cos(r)*e.radius*.4,Math.sin(r)*e.radius*.25,Math.sin(r)*e.radius*.4),s.add(n)}s.position.set(e.radius*2,.15,0),t.add(s);let p=new Wn;p.name=`RADIO`;let m=new X(new sa(e.radius*.21,32,32),new ya({color:2330328,metalness:.48,roughness:.22,emissive:411765,emissiveIntensity:.8}));p.add(m);let h=new X(new sa(e.radius*.55,16,16),new ri({transparent:!0,opacity:0,depthWrite:!1}));h.name=`RADIO_HITBOX`,p.add(h);let g=new X(new Ji(e.radius*.014,e.radius*.022,e.radius*.45,12),new ya({color:12115967,metalness:.8,roughness:.18}));g.position.y=e.radius*.32,p.add(g);let _=new X(new sa(e.radius*.17,24,12,0,Math.PI*2,0,Math.PI*.5),new ya({color:10214655,metalness:.72,roughness:.18,emissive:1204368,emissiveIntensity:.55,side:2}));_.position.y=e.radius*.54,_.rotation.x=-Math.PI*.25,p.add(_);let v=new ri({color:5626367,transparent:!0,opacity:.48});for(let t=0;t<3;t++){let n=new X(new ca(e.radius*(.28+t*.12),e.radius*.012,8,48,Math.PI),v);n.position.set(e.radius*(.16+t*.04),e.radius*(.68+t*.06),0),n.rotation.z=-Math.PI*.5,p.add(n)}p.position.set(0,e.radius*2,-e.radius*.1),t.add(p),t.userData.menuPositions={TRACKS:new K(-e.radius*2,0,0),MIXES:new K(0,e.radius*2,0),RADIO:new K(e.radius*2,0,0)},t.userData.menuRotations={TRACKS:new En(0,0,0),MIXES:new En(0,0,0),RADIO:new En(0,0,0)},t.userData.freePositions={TRACKS:n.position.clone(),MIXES:s.position.clone(),RADIO:p.position.clone()},o.userData.audioSatellites=t}if(e.name===`VIDEOS`){let t=new Wn;t.name=`VIDEOS_SATELLITES`;let n=new Wn;n.name=`YOUTUBE`;let r=new X(new sa(e.radius*.3,32,32),new ya({color:1381653,metalness:.65,roughness:.25,emissive:3145728,emissiveIntensity:.55}));n.add(r);let i=new X(new ca(e.radius*.42,e.radius*.018,10,48),new ri({color:16724016,transparent:!0,opacity:.9}));i.rotation.x=Math.PI*.43,i.rotation.z=Math.PI*.18,n.add(i),n.scale.set(1.8,1.8,1.8),n.position.set(e.radius*2,0,0),t.add(n),t.userData.youtube=n,t.userData.freePosition=n.position.clone(),t.userData.orbitRadius=e.radius*2,t.userData.orbitAngle=0,t.userData.inverseQuaternion=new qt,t.userData.targetPosition=new K,t.userData.worldPosition=new K,o.add(t),o.userData.videosSatellites=t}let l={mesh:o,speed:e.speed,base:o.position.clone(),driftX:.1+Math.random()*.16,driftY:.08+Math.random()*.14,driftZ:.06+Math.random()*.12,ampX:.35+Math.random()*.35,ampY:.25+Math.random()*.3,ampZ:.2+Math.random()*.3,phaseX:Math.random()*Math.PI*2,phaseY:Math.random()*Math.PI*2,phaseZ:Math.random()*Math.PI*2,selectionOffset:new K};A.push(l);let d=document.createElement(`div`);if(d.className=`planet-name`,d.textContent=e.name,d.style.position=`absolute`,d.style.color=`#ffffff`,d.style.fontSize=`8px`,d.style.letterSpacing=`0.28em`,d.style.fontFamily=`Arial, Helvetica, sans-serif`,d.style.pointerEvents=`none`,d.style.whiteSpace=`nowrap`,d.style.transform=`translate(-50%, -50%)`,d.style.opacity=`0.8`,d.style.zIndex=`20`,i.appendChild(d),l.nameLabel=d,e.rings){let t=k.load(`/textures/planets/saturn-ring.png`);t.colorSpace=rt;let n=new X(new oa(e.radius*1.25,e.radius*2.05,96),new ya({map:t,transparent:!0,side:2,depthWrite:!1,roughness:.85}));n.rotation.x=Math.PI/2.25,n.rotation.z=.15,o.add(n)}});let ee={};[`TRACKS`,`MIXES`,`RADIO`].forEach(e=>{let t=document.createElement(`div`);t.style.position=`absolute`,t.style.left=`0`,t.style.top=`0`,t.style.transform=`translate(-50%, -50%)`,t.style.color=`#ffffff`,t.style.fontSize=`9px`,t.style.fontFamily=`Arial, Helvetica, sans-serif`,t.style.fontWeight=`400`,t.style.letterSpacing=`0.32em`,t.style.textTransform=`uppercase`,t.style.whiteSpace=`nowrap`,t.style.pointerEvents=`none`,t.style.opacity=`0`,t.style.transition=`opacity 0.25s ease`,t.style.zIndex=`21`,t.textContent=e,i.appendChild(t),ee[e]=t});let j=document.createElement(`div`);j.style.position=`absolute`,j.style.left=`0`,j.style.top=`0`,j.style.transform=`translate(-50%, -50%)`,j.style.color=`#ffffff`,j.style.fontSize=`9px`,j.style.fontFamily=`Arial, Helvetica, sans-serif`,j.style.fontWeight=`400`,j.style.letterSpacing=`0.32em`,j.style.whiteSpace=`nowrap`,j.style.pointerEvents=`none`,j.style.opacity=`0`,j.style.transition=`opacity 0.25s ease`,j.style.zIndex=`21`,j.textContent=`YOUTUBE`,i.appendChild(j);let te=new Eo,ne=new G,re=null,M=null,N=!1,P=!1,ie=0,ae=0,F=17,oe=new K(0,0,17),I=new K(0,0,0),L=e=>{let t=d.getBoundingClientRect();ne.x=(e.clientX-t.left)/t.width*2-1,ne.y=-((e.clientY-t.top)/t.height*2-1)},se=e=>{L(e),te.setFromCamera(ne,l);let t=A.map(({mesh:e})=>e),n=[];for(let{mesh:e}of A)e.userData.name===`VIDEOS`&&e.userData.videosSatellites&&e.userData.videosSatellites.traverse(e=>{e.isMesh&&e.visible&&n.push(e)}),e.userData.name===`AUDIO`&&e.userData.audioSatellites&&e.userData.audioSatellites.traverse(e=>{e.isMesh&&e.visible&&n.push(e)});let r=te.intersectObjects(t,!1),i=te.intersectObjects(n,!1);return i.length?i[0].object:r.length?r[0].object:null},ce=!1,le=!1,ue=e=>{let t=se(e);if(t&&!P?(re=t,d.style.cursor=`pointer`):P||(re=null,d.style.cursor=`default`),!P)return;let n=e.clientX-ie,r=e.clientY-ae;(Math.abs(n)>2||Math.abs(r)>2)&&(ce=!0),ie=e.clientX,ae=e.clientY,M&&(M.rotation.y+=n*.01,M.rotation.x+=r*.005,M.rotation.x=Kt.clamp(M.rotation.x,-Math.PI*.45,Math.PI*.45))},de=r=>{if(r.pointerType===`mouse`&&r.button!==0)return;let o=se(r);if(!o){P=!1;return}if(o.userData.name===`RELEASES`){let e=document.getElementById(`nyxtryp-releases-window`);e&&e.remove();let t=document.createElement(`div`);t.id=`nyxtryp-releases-window`,t.style.position=`absolute`,t.style.inset=`0`,t.style.zIndex=`100`,t.style.background=`rgba(0,0,0,0.94)`,t.style.display=`flex`,t.style.alignItems=`center`,t.style.justifyContent=`center`,t.style.overflow=`hidden`,t.style.fontFamily=`Arial, Helvetica, sans-serif`;let n=document.createElement(`button`);n.textContent=`×`,n.style.position=`absolute`,n.style.right=`24px`,n.style.top=`18px`,n.style.zIndex=`5`,n.style.border=`0`,n.style.background=`transparent`,n.style.color=`#ffffff`,n.style.fontSize=`30px`,n.style.fontWeight=`200`,n.style.cursor=`pointer`,n.style.opacity=`0.75`,n.onclick=()=>t.remove(),t.appendChild(n);let r=document.createElement(`div`);r.style.position=`relative`,r.style.width=`min(900px, 86vw)`,r.style.height=`min(650px, 78vh)`,r.style.display=`flex`,r.style.flexDirection=`column`,r.style.alignItems=`center`,r.style.justifyContent=`center`,r.style.overflow=`hidden`,t.appendChild(r);let i=document.createElement(`div`);i.textContent=`RELEASES`,i.style.color=`#ffffff`,i.style.fontSize=`clamp(32px, 6vw, 72px)`,i.style.fontWeight=`300`,i.style.letterSpacing=`0.18em`,i.style.textAlign=`center`,i.style.marginBottom=`32px`,r.appendChild(i);let a=document.createElement(`div`);a.textContent=`No releases yet.
New music is coming.`,a.style.color=`rgba(255,255,255,0.72)`,a.style.fontSize=`clamp(15px, 2vw, 19px)`,a.style.fontWeight=`300`,a.style.letterSpacing=`0.08em`,a.style.lineHeight=`1.8`,a.style.textAlign=`center`,a.style.whiteSpace=`pre-line`,r.appendChild(a),document.body.appendChild(t);return}let s=null,c=o;for(;c;){if(c.name===`YOUTUBE`){s=c;break}c=c.parent}if(s){if(!(M&&M.userData.name===`VIDEOS`&&F<10)){P=!1,ce=!1,le=!1;return}window.open(`https://www.youtube.com/@nyxtryp`,`_blank`,`noopener,noreferrer`),P=!1,ce=!1,le=!1;return}let f=null;for(c=o;c;){if(c.name===`RADIO`){f=c;break}c=c.parent}if(f){N&&M&&M.userData.name===`AUDIO`&&e&&e(),P=!1,ce=!1,le=!1;return}let p=null;for(c=o;c;){if(c.name===`TRACKS`){p=c;break}c=c.parent}if(p){N&&M&&M.userData.name===`AUDIO`&&n&&n(),P=!1,ce=!1,le=!1;return}let m=null;for(c=o;c;){if(c.name===`MIXES`){m=c;break}c=c.parent}if(m){N&&M&&M.userData.name===`AUDIO`&&t&&t(),P=!1,ce=!1,le=!1;return}if(o.userData.name===`VISUALS`){y(`VISUALS cinematic flight opened`);let e=document.getElementById(`nyxtryp-visuals-window`);e&&e.remove();let t=document.createElement(`div`);t.id=`nyxtryp-visuals-window`,Object.assign(t.style,{position:`fixed`,inset:`0`,zIndex:`100000`,background:`transparent`,pointerEvents:`none`,overflow:`hidden`});let n=document.createElement(`button`);n.textContent=`×`,Object.assign(n.style,{position:`absolute`,top:`22px`,right:`28px`,zIndex:`20`,background:`transparent`,border:`0`,color:`rgba(255,255,255,.72)`,fontSize:`28px`,fontWeight:`200`,cursor:`pointer`,pointerEvents:`auto`,lineHeight:`1`,padding:`8px`,fontFamily:`Arial, Helvetica, sans-serif`}),t.appendChild(n),document.body.appendChild(t);let r=l.position.clone(),i=l.quaternion.clone(),o=oe.clone(),s=I.clone(),c=M,d=F,f=u.getPixelRatio(),p=!0,m=!1,h=performance.now();new K,new K,new K;let g=[];document.querySelectorAll(`.planet-name`).forEach(e=>{g.push({label:e,opacity:e.style.opacity}),e.style.opacity=`0`}),Object.values(ee).forEach(e=>{g.push({label:e,opacity:e.style.opacity}),e.style.opacity=`0`}),j.style.opacity=`0`;let _=e=>{let t=A.find(t=>t.mesh&&t.mesh.userData&&t.mesh.userData.name===e);return t?t.mesh:null},v=e=>{let t=new K;return e.getWorldPosition(t),t},b=(e,t)=>{let n=_(e);if(!n)return null;let r=v(n),i=r.clone().sub(l.position).normalize();return r.clone().sub(i.multiplyScalar(t))},x=new Wn;x.name=`NYXTRYP_VISUALS_METEORS`,a.add(x);let S=new ia(.08,1),C=new ya({color:7829367,roughness:.92,metalness:.05}),w=[];for(let e=0;e<90;e++){let e=new X(S,C);e.position.set(Kt.randFloatSpread(34),Kt.randFloatSpread(22),Kt.randFloat(-8,-70));let t=Kt.randFloat(.35,3.2);e.scale.setScalar(t),e.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),e.userData.velocity=new K(Kt.randFloat(-.035,.035),Kt.randFloat(-.035,.035),Kt.randFloat(.1,.38)),e.userData.spin=new K(Kt.randFloat(-.025,.025),Kt.randFloat(-.025,.025),Kt.randFloat(-.025,.025)),x.add(e),w.push(e)}let T=[];[`TRACKS`,`MIXES`,`RADIO`,`YOUTUBE`].forEach((e,t)=>{let n=a.getObjectByName(e);if(!n)return;let r=n.clone(!0),i=v(n);r.position.copy(i),r.quaternion.copy(n.getWorldQuaternion(new qt)),r.scale.multiplyScalar(1.15),r.userData.cinematic=!0,r.userData.index=t,a.add(r),T.push(r)});let E=[`AUDIO`,`VIDEOS`,`PHOTOS`,`RELEASES`,`GUESTBOOK`,`ABOUT`,`SOCIAL`],D=[];D.push(l.position.clone()),E.forEach(e=>{let t=b(e,Kt.randFloat(2.4,4.8));t&&D.push(t)}),D.push(new K(0,1.5,-31));let O=new ra(D,!1,`catmullrom`,.48),k=l.position.clone(),te=new K,ne=l.position.clone(),re=0,N=performance.now(),P=document.createElement(`div`);Object.assign(P.style,{position:`absolute`,inset:`0`,background:`#000`,opacity:`0`,pointerEvents:`none`,transition:`opacity 1.8s ease`,zIndex:`5`}),t.appendChild(P);let ie=document.createElement(`div`);Object.assign(ie.style,{position:`absolute`,inset:`0`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,opacity:`0`,transition:`opacity 2.5s ease`,color:`#fff`,fontFamily:`Arial, Helvetica, sans-serif`,pointerEvents:`none`,zIndex:`10`});let ae=document.createElement(`div`);ae.textContent=`NYXTRYP`,Object.assign(ae.style,{fontSize:`clamp(38px, 7vw, 86px)`,fontWeight:`200`,letterSpacing:`0.42em`,marginLeft:`0.42em`,textShadow:`0 0 35px rgba(180,220,255,.35)`});let L=document.createElement(`div`);L.textContent=`SEE YOU`,Object.assign(L.style,{marginTop:`18px`,fontSize:`11px`,fontWeight:`300`,letterSpacing:`0.65em`,marginLeft:`0.65em`,opacity:`0.62`}),ie.appendChild(ae),ie.appendChild(L),t.appendChild(ie);let se={x:0,y:0,targetX:0,targetY:0},ce=e=>{let t=e.clientX??(e.touches&&e.touches[0]&&e.touches[0].clientX),n=e.clientY??(e.touches&&e.touches[0]&&e.touches[0].clientY);t!=null&&n!=null&&(se.targetX=(t/window.innerWidth-.5)*2,se.targetY=(n/window.innerHeight-.5)*2)};window.addEventListener(`pointermove`,ce);let le=e=>{if(!p)return;let t=e-h,n=Math.min(1,t/6e4),r=Math.min(.05,(e-N)/1e3);N=e;let i;if(n<.1){let e=n/.1;i=e*e*.12}else i=n<.78?.12+(n-.1)/.68*.68:.8+(n-.78)/.22*.2;let o=O.getPointAt(Kt.clamp(i,0,1)),s=O.getTangentAt(Kt.clamp(i,0,.999));se.x+=(se.targetX-se.x)*Math.min(1,r*2.8),se.y+=(se.targetY-se.y)*Math.min(1,r*2.8),k.lerp(o,Math.min(1,r*5.5));let c=new K().crossVectors(s,l.up).normalize(),d=new K().crossVectors(c,s).normalize();k.addScaledVector(c,se.x*1.35),k.addScaledVector(d,-se.y*.95),l.position.copy(k),te.copy(k),te.addScaledVector(s,5.5);let f=Math.sin(t*42e-5)*.018+se.x*.025;l.lookAt(te),l.rotateZ(f);let g=1+n*2.8;if(w.forEach((e,t)=>{let n=e.userData.velocity;e.position.x+=n.x*g,e.position.y+=n.y*g,e.position.z+=n.z*g,e.rotation.x+=e.userData.spin.x,e.rotation.y+=e.userData.spin.y,e.rotation.z+=e.userData.spin.z;let r=e.position.clone().sub(l.position);(r.length()>75||r.z>12)&&(e.position.copy(l.position),e.position.addScaledVector(s,Kt.randFloat(-45,-18)),e.position.addScaledVector(c,Kt.randFloat(-16,16)),e.position.addScaledVector(d,Kt.randFloat(-12,12)))}),T.forEach((e,n)=>{let i=t*(25e-5+n*35e-6);e.position.add(new K(Math.sin(i*1.7+n)*r*2.2,Math.cos(i*1.3+n)*r*1.6,Math.sin(i*.9+n)*r*3.8)),e.rotation.y+=r*(.35+n*.11),e.position.clone().sub(l.position).length()>55&&(e.position.copy(l.position),e.position.addScaledVector(s,Kt.randFloat(-18,6)),e.position.addScaledVector(c,Kt.randFloat(-10,10)),e.position.addScaledVector(d,Kt.randFloat(-8,8)))}),n>.84){let e=(n-.84)/.16;P.style.opacity=String(Math.min(.92,e*1.25))}n>=1&&!m&&(m=!0,P.style.opacity=`1`,setTimeout(()=>{ie.style.opacity=`1`},1500)),u.render(a,l),ne.copy(l.position),re=requestAnimationFrame(le)},ue=()=>{p&&(p=!1,cancelAnimationFrame(re),window.removeEventListener(`pointermove`,ce),x.removeFromParent(),T.forEach(e=>{e.removeFromParent()}),S.dispose(),C.dispose(),l.position.copy(r),l.quaternion.copy(i),oe.copy(o),I.copy(s),F=d,M=c,u.setPixelRatio(f),g.forEach(({label:e,opacity:t})=>{e.style.opacity=t}),j.style.opacity=`0`,t.remove(),u.render(a,l))};n.addEventListener(`click`,ue);let de=e=>{e.key===`Escape`&&(ue(),window.removeEventListener(`keydown`,de))};window.addEventListener(`keydown`,de),requestAnimationFrame(le);return}if(o.userData.name===`GUESTBOOK`){y(`GUESTBOOK opened`);let e=document.getElementById(`nyxtryp-guestbook-window`);e&&e.remove();let t=document.createElement(`style`);t.id=`nyxtryp-guestbook-style`,t.textContent=`
...
Оставайся в движении.`:c,d()},a.appendChild(s),requestAnimationFrame(()=>{setTimeout(()=>{o.style.top=`8%`,o.style.transform=`translateY(0)`,o.style.fontSize=`clamp(24px, 4vw, 48px)`,o.style.letterSpacing=`0.22em`,setTimeout(()=>{d()},700)},150)}),t.onclick=e=>{e.target===t&&t.remove()},i.appendChild(t),P=!1,ce=!1,le=!1;return}if(M===o){le=!0,ce=!1,P=!0,ie=r.clientX,ae=r.clientY,d.style.cursor=`grabbing`;return}le=!1,ce=!1,M=o,N=o.userData.name===`AUDIO`,F=Kt.clamp(o.geometry.parameters.radius*7,4.5,8),P=!0,ie=r.clientX,ae=r.clientY,d.style.cursor=`grabbing`},fe=()=>{P=!1,le&&!ce&&(M=null,N=!1,F=17),le=!1,ce=!1,re?d.style.cursor=`pointer`:d.style.cursor=`default`},pe=e=>{e.preventDefault(),M&&(F+=e.deltaY*.012,F=Kt.clamp(F,Math.max(1.8,M.geometry.parameters.radius*2.2),17))};d.addEventListener(`pointermove`,ue),d.addEventListener(`pointerdown`,de),d.addEventListener(`pointerup`,fe),d.addEventListener(`pointercancel`,fe),d.addEventListener(`wheel`,pe,{passive:!1});let me,he=!1,ge=()=>{if(!he)try{let e=performance.now()*.001;p+=1;let t=performance.now(),n=t-h;h=t,n>0&&(g=Math.round(1e3/n)),p%60==0&&f&&v(`WEBGL RUNNING`,`No context loss detected yet.`),A.forEach(t=>{let{mesh:n,speed:r,base:i,driftX:a,driftY:o,driftZ:s,ampX:c,ampY:u,ampZ:f,phaseX:p,phaseY:m,phaseZ:h}=t;if(t.nameLabel){let e=new K;n.getWorldPosition(e),e.y+=n.geometry.parameters.radius*1.6,e.project(l);let r=d.getBoundingClientRect();t.nameLabel.style.left=(e.x+1)/2*r.width+`px`,t.nameLabel.style.top=(-e.y+1)/2*r.height+`px`;let i=n.position.clone().sub(l.position).normalize(),a=new Eo(l.position,i),o=A.filter(e=>e.mesh!==n).map(e=>e.mesh),s=a.intersectObjects(o,!1);t.nameLabel.style.opacity=s.length?`0`:`0.8`}n!==M&&(n.userData.name===`VIDEOS`?n.rotation.y-=r:n.rotation.y+=r);let g=n.userData.videosSatellites;if(g){let e=g.userData.youtube,i=g.userData.orbitRadius,a=n===M&&F<10;if(a){let t=g.userData.inverseQuaternion;t.copy(n.quaternion).invert();let r=g.userData.targetPosition;r.set(-i,0,0).applyQuaternion(t),e.position.lerp(r,.08)}else{e.rotation.y-=r*2,g.userData.orbitAngle-=r*6;let t=g.userData.orbitAngle;e.position.set(Math.cos(t)*i,0,Math.sin(t)*i)}let o=g.userData.worldPosition;e.getWorldPosition(o),o.y+=n.geometry.parameters.radius*.65,o.project(l);let s=d.getBoundingClientRect();j.style.left=(o.x+1)/2*s.width+`px`,j.style.top=(-o.y+1)/2*s.height+`px`,j.style.opacity=a?`0.8`:`0`,a&&t.nameLabel&&(t.nameLabel.style.opacity=`0.8`),a&&t.nameLabel&&(t.nameLabel.style.opacity=`0.8`)}let _=n.userData.audioSatellites;if(_){let e=_.userData.menuPositions,t=_.userData.freePositions;if(e&&t){let r=N&&n===M,i=n.quaternion.clone().invert(),a={TRACKS:e.TRACKS.clone(),MIXES:e.MIXES.clone(),RADIO:e.RADIO.clone()},o={TRACKS:a.TRACKS.applyQuaternion(i),MIXES:a.MIXES.applyQuaternion(i),RADIO:a.RADIO.applyQuaternion(i)},s={TRACKS:r?o.TRACKS:t.TRACKS,MIXES:r?o.MIXES:t.MIXES,RADIO:r?o.RADIO:t.RADIO},c=_.userData.menuRotations,l=_.getObjectByName(`TRACKS`),u=_.getObjectByName(`MIXES`),d=_.getObjectByName(`RADIO`);l&&(l.position.lerp(s.TRACKS,.08),r&&l.quaternion.slerp(new qt().setFromEuler(c.TRACKS).premultiply(i),.08)),u&&(u.position.lerp(s.MIXES,.08),r&&u.quaternion.slerp(new qt().setFromEuler(c.MIXES).premultiply(i),.08)),d&&(d.position.lerp(s.RADIO,.08),r&&d.quaternion.slerp(new qt().setFromEuler(c.RADIO).premultiply(i),.08))}}let v=i.x+Math.sin(e*a+p)*c,y=i.y+Math.sin(e*o+m)*u,b=i.z+Math.sin(e*s+h)*f,x=new K(0,0,l.position.z-F),S=new K(v,y,b),C=n===M?x.sub(S):new K;t.selectionOffset.lerp(C,.045),n.position.set(v+t.selectionOffset.x,y+t.selectionOffset.y,b+t.selectionOffset.z)}),oe.lerp(new K(0,0,window.innerWidth<768?28:17),.05),I.lerp(new K(0,0,0),.05),l.position.copy(oe),l.lookAt(I),[`TRACKS`,`MIXES`,`RADIO`].forEach(e=>{let t=ee[e];if(!t)return;let n=(M?.userData?.audioSatellites)?.getObjectByName(e);if(N&&n){let e=n.getWorldPosition(new K);e.y+=M.geometry.parameters.radius*.48;let r=e.project(l),i=d.getBoundingClientRect();t.style.left=`${(r.x+1)*.5*i.width}px`,t.style.top=`${(-r.y+1)*.5*i.height}px`,t.style.opacity=`1`}else t.style.opacity=`0`}),E.forEach(({object:e,speed:t},n)=>{e.rotation.y+=t*(n+1),e.rotation.x+=t*.35});let r=1+Math.sin(e*.45)*.025;w.scale.setScalar(r),T.scale.setScalar(1+Math.sin(e*.45)*.05),O.forEach(e=>{e.active?(e.life+=.016,e.object.position.x-=.22,e.object.position.y-=.08,e.object.material.opacity=Math.max(0,1-e.life/.8),e.life>.8&&(e.active=!1,e.timer=8+Math.random()*18)):(e.timer-=.016,e.timer<=0&&(e.active=!0,e.life=0,e.object.position.set((Math.random()-.5)*24,6+Math.random()*8,-10-Math.random()*30),e.object.material.opacity=1))}),u.render(a,l),me=requestAnimationFrame(ge)}catch(e){_=`ANIMATE LOOP CRASH`,v(`!!! ANIMATION LOOP CRASH !!!`,String(e?.stack||e?.message||e)),console.error(`NYXTRYP ANIMATE LOOP CRASH:`,e);return}},_e=()=>{let e=i.clientWidth,t=i.clientHeight;l.aspect=e/t,l.updateProjectionMatrix(),u.setSize(e,t)};return _e(),window.addEventListener(`resize`,_e),ge(),()=>{cancelAnimationFrame(me),window.removeEventListener(`resize`,_e),d.removeEventListener(`pointermove`,ue),d.removeEventListener(`pointerdown`,de),d.removeEventListener(`pointerup`,fe),d.removeEventListener(`pointercancel`,fe),d.removeEventListener(`wheel`,pe),A.forEach(({mesh:e})=>{e.geometry.dispose(),e.material.map?.dispose(),e.material.dispose()}),E.forEach(({object:e})=>{e.geometry.dispose(),e.material.dispose()}),O.forEach(({object:e})=>{e.geometry.dispose(),e.material.dispose()}),Object.values(ee).forEach(e=>{e.remove()}),document.querySelectorAll(`.planet-name`).forEach(e=>{e.remove()}),u.dispose(),i.contains(u.domElement)&&i.removeChild(u.domElement)}},[]),(0,x.jsx)(`div`,{ref:r,className:`planet-field`})}var Yl=[{title:`Amazing Nature`,file:`/media/radio/Amazing_Nature.mp3`},{title:`Calm Vibrations`,file:`/media/radio/Calm_Vibrations.mp3`},{title:`Deep Sleep`,file:`/media/radio/Deep_Sleep.mp3`},{title:`Forest Before Rain`,file:`/media/radio/Forest_Before_Rain.mp3`},{title:`Forest Sounds`,file:`/media/radio/Forest_Sounds.mp3`},{title:`Harmony`,file:`/media/radio/Harmony.mp3`},{title:`Inner Peace`,file:`/media/radio/Inner_Peace.mp3`},{title:`Inside Japan`,file:`/media/radio/Inside_Japan.mp3`},{title:`Iren Lullaby`,file:`/media/radio/Iren_Lullaby.mp3`},{title:`Morning Prayer`,file:`/media/radio/Morning_Prayer.mp3`},{title:`Ocean Waves`,file:`/media/radio/Ocean_Waves.mp3`},{title:`Path to Happiness`,file:`/media/radio/Path_to_Happiness.mp3`},{title:`Quiet Place`,file:`/media/radio/Quiet_Place.mp3`},{title:`Sparks`,file:`/media/radio/Sparks.mp3`},{title:`Thunderstorm`,file:`/media/radio/Thunderstorm.mp3`}];function Xl(e=-1){if(Yl.length<=1)return 0;let t=Math.floor(Math.random()*Yl.length);for(;t===e;)t=Math.floor(Math.random()*Yl.length);return t}function Zl({onClose:e}){if(!document.getElementById(`lori-animation`)){let e=document.createElement(`style`);e.id=`lori-animation`,e.innerHTML=`
      @keyframes loriPulse {
        0%,100% {
          opacity: .45;
    ...
    `,document.head.appendChild(e)}let t=(0,b.useRef)(null),n=(0,b.useRef)(null),r=(0,b.useRef)(null),i=(0,b.useRef)(null),a=(0,b.useRef)(null),o=(0,b.useRef)(null),[s,c]=(0,b.useState)(!1),[l,u]=(0,b.useState)(!1),[d,f]=(0,b.useState)(.68),[p,m]=(0,b.useState)(()=>Xl()),[,h]=(0,b.useState)(0),[g,_]=(0,b.useState)(92),[v,y]=(0,b.useState)(`1.4s`),S=Yl[p];(0,b.useEffect)(()=>{let e=!1;return fetch(`/api/media`,{cache:`no-store`}).then(e=>{if(!e.ok)throw Error(`media api failed`);return e.json()}).then(t=>{if(e||!Array.isArray(t.radio)||!t.radio.length)return;let n=t.radio.map(e=>({title:e.replace(/\.mp3$/i,``),file:t.radioUrls?.[e]||`/media/radio/${encodeURIComponent(e)}`}));Yl.splice(0,Yl.length,...n),m(e=>Math.min(e,n.length-1)),h(e=>e+1)}).catch(()=>{}),()=>{e=!0}},[]);let C=()=>{let e=t.current;if(!e)return null;if(r.current)return r.current;let n=window.AudioContext||window.webkitAudioContext;if(!n)return null;let o=new n,s=o.createAnalyser();s.fftSize=2048,s.smoothingTimeConstant=.78;let c=o.createMediaElementSource(e);return c.connect(s),s.connect(o.destination),r.current=o,i.current=s,a.current=c,o};return(0,b.useEffect)(()=>{let e=n.current,t=i.current;if(!e||!t)return;let a=e.getContext(`2d`),c=new Uint8Array(t.frequencyBinCount),l=Array(64).fill(0),u=()=>{let n=e.width,i=e.height;a.clearRect(0,0,n,i),t.getByteFrequencyData(c);let d=25e3,f=(r.current?.sampleRate||44100)/t.fftSize,p=(n-126)/64;for(let e=0;e<64;e++){let t=16*(d/16)**(e/64),n=16*(d/16)**((e+1)/64),r=Math.floor(t/f),o=Math.max(r+1,Math.floor(n/f)),u=0,m=0;for(let e=r;e<o&&e<c.length;e++)u+=c[e],m++;let h=u/Math.max(m,1)/255;h=Math.min(h,.85)**2.4,h*=1,l[e]+=((s?h:.05)-l[e])*.08;let g=i*(l[e]/(l[e]+.45))*.95,_=e*(p+2),v=i-g,y=a.createLinearGradient(0,v,0,i);y.addColorStop(0,`rgba(130,220,255,0.95)`),y.addColorStop(1,`rgba(80,130,255,0.15)`),a.fillStyle=y,a.fillRect(_,v,p,g)}o.current=requestAnimationFrame(u)};return u(),()=>{o.current&&cancelAnimationFrame(o.current)}},[s]),(0,b.useEffect)(()=>{let e=t.current;e&&(e.volume=d,e.muted=l)},[d,l]),(0,b.useEffect)(()=>{let e=setInterval(()=>{_(88+Math.floor(Math.random()*10));let e=(1.1+Math.random()*1).toFixed(1);y(`${e}s`)},1800);return()=>clearInterval(e)},[]),(0,b.useEffect)(()=>{let e=t.current;e&&(e.src=S.file,e.load(),(async()=>{try{let t=C();t&&t.state===`suspended`&&await t.resume(),await e.play(),c(!0)}catch{c(!1)}})())},[p]),(0,x.jsxs)(`div`,{style:{width:`min(420px, 90vw)`,padding:`46px 26px 22px`,borderRadius:`24px`,background:`linear-gradient(145deg, rgba(9,15,27,.94), rgba(3,7,15,.97))`,border:`1px solid rgba(125,190,255,.20)`,boxShadow:`0 20px 70px rgba(0,0,0,.55), inset 0 0 40px rgba(70,150,255,.035)`,color:`#eaf4ff`,fontFamily:`Inter, system-ui, sans-serif`,backdropFilter:`blur(18px)`,position:`relative`},children:[(0,x.jsx)(`audio`,{ref:t,onEnded:()=>{m(e=>Xl(e))}}),(0,x.jsx)(`button`,{onClick:e,"aria-label":`Close radio`,style:{position:`absolute`,top:14,right:16,zIndex:5,border:`none`,background:`transparent`,color:`rgba(220,240,255,.62)`,fontSize:22,fontWeight:300,lineHeight:1,cursor:`pointer`,padding:`4px 7px`},children:`×`}),(0,x.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`flex-start`,marginBottom:22},children:[(0,x.jsxs)(`div`,{children:[(0,x.jsx)(`div`,{style:{fontSize:11,letterSpacing:`3px`,opacity:.55,marginBottom:7},children:`NYXTRYP`}),(0,x.jsxs)(`div`,{style:{fontSize:21,letterSpacing:`4px`,fontWeight:500,display:`flex`,gap:`4px`},children:[(0,x.jsx)(`span`,{children:`Radio\xA0`}),`LORI`.split(``).map((e,t)=>(0,x.jsx)(`span`,{style:{animation:`loriPulse ${1.6+t*.3}s ease-in-out infinite`,animationDelay:`${t*.35}s`},children:e},t))]}),(0,x.jsx)(`div`,{style:{marginTop:7,fontSize:9,letterSpacing:`2px`,opacity:.42},children:`RELAXATION · AMBIENT · CONTINUOUS`})]}),(0,x.jsxs)(`div`,{style:{textAlign:`right`,fontSize:9,letterSpacing:`1.5px`},children:[(0,x.jsx)(`div`,{style:{color:`#75d8ff`,marginBottom:6},children:`● SIGNAL LINK`}),(0,x.jsx)(`div`,{style:{opacity:.5},children:`EARTH RELAY`})]})]}),(0,x.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:8,marginBottom:18},children:[Array.from({length:12}).map((e,t)=>{let n=t<Math.round(g/8);return(0,x.jsx)(`div`,{style:{width:5,height:7+t*1.4,borderRadius:2,background:n?`#70d8ff`:`rgba(120,180,220,.12)`,boxShadow:n?`0 0 8px rgba(90,210,255,.5)`:`none`}},t)}),(0,x.jsxs)(`div`,{style:{marginLeft:`auto`,fontSize:9,letterSpacing:`1px`,opacity:.55},children:[g,`% · `,v]})]}),(0,x.jsx)(`div`,{style:{height:105,borderRadius:14,overflow:`hidden`,padding:`0 22px`,background:`rgba(0,0,0,.20)`,border:`1px solid rgba(100,180,255,.08)`,marginBottom:18},children:(0,x.jsx)(`canvas`,{ref:n,width:720,height:210,style:{width:`100%`,height:`100%`,display:`block`}})}),(0,x.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:12,marginBottom:16},children:[(0,x.jsx)(`button`,{onClick:async()=>{let e=t.current;if(e){if(s){e.pause(),c(!1);return}try{let t=C();t&&t.state===`suspended`&&await t.resume(),await e.play(),c(!0)}catch{c(!1)}}},style:{width:42,height:42,borderRadius:`50%`,border:`1px solid rgba(120,210,255,.28)`,background:`rgba(80,170,255,.08)`,color:`#dff7ff`,cursor:`pointer`,fontSize:16},children:s?`Ⅱ`:`▶`}),(0,x.jsxs)(`div`,{style:{flex:1,minWidth:0},children:[(0,x.jsx)(`div`,{style:{fontSize:10,letterSpacing:`1.8px`,opacity:.42,marginBottom:5},children:`NOW TRANSMITTING`}),(0,x.jsx)(`div`,{style:{fontSize:13,letterSpacing:`1px`,whiteSpace:`nowrap`,overflow:`hidden`,textOverflow:`ellipsis`},children:S.title})]})]}),(0,x.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:10},children:[(0,x.jsx)(`button`,{onClick:()=>u(e=>!e),style:{border:`none`,background:`transparent`,color:`rgba(220,240,255,.7)`,cursor:`pointer`,fontSize:16},children:l?`🔇`:`🔊`}),(0,x.jsx)(`input`,{type:`range`,min:`0`,max:`1`,step:`0.01`,value:d,onChange:e=>f(Number(e.target.value)),style:{flex:1,accentColor:`#73d8ff`}}),(0,x.jsx)(`span`,{style:{fontSize:9,opacity:.42,minWidth:28,textAlign:`right`},children:Math.round(d*100)})]})]})}var Ql=[{title:`Divine Artist - Best of Ethnic`,file:`/media/mixes/Divine Artist - Best of Ethnic.mp3`},{title:`Midnight in Cairo Arabic Jazz & Oud Melodies for Late Night Reflection`,file:`/media/mixes/Midnight in Cairo Arabic Jazz & Oud Melodies for Late Night Reflection.mp3`},{title:`Moon Over Arabia Desert Media`,file:`/media/mixes/Moon Over Arabia Desert Media.mp3`},{title:`TRANCE FESTIVAL 2026 🔥 🎶 Best of .mp3`,file:`/media/mixes/TRANCE FESTIVAL 2026 🔥 🎶 Best of .mp3`}];function $l(e){if(!Number.isFinite(e)||e<0)return`0:00`;let t=Math.floor(e/60),n=Math.floor(e%60);return`${t}:${String(n).padStart(2,`0`)}`}function eu({onClose:e}){let t=(0,b.useRef)(null),n=(0,b.useRef)(null),r=(0,b.useRef)(null),i=(0,b.useRef)(null),a=(0,b.useRef)(null),o=(0,b.useRef)(null),[s,c]=(0,b.useState)(!1),[l,u]=(0,b.useState)(!1),[d,f]=(0,b.useState)(.68),[p,m]=(0,b.useState)(0),[h,g]=(0,b.useState)(0),[_,v]=(0,b.useState)(0),[y,S]=(0,b.useState)(92),[C,w]=(0,b.useState)(`1.4s`),[,T]=(0,b.useState)(0),E=Ql[p];(0,b.useEffect)(()=>{let e=!1;return fetch(`/api/media`,{cache:`no-store`}).then(e=>e.ok?e.json():Promise.reject(Error(`media api failed`))).then(t=>{if(e||!Array.isArray(t.mixes)||!t.mixes.length)return;let n=t.mixes.map(e=>({title:e.replace(/\.mp3$/i,``),file:t.mixUrls?.[e]||`/media/mixes/${encodeURIComponent(e)}`}));Ql.splice(0,Ql.length,...n),m(e=>Math.min(e,n.length-1)),T(e=>e+1)}).catch(()=>{}),()=>{e=!0}},[]),(0,b.useEffect)(()=>{if(document.getElementById(`mixes-animation`))return;let e=document.createElement(`style`);return e.id=`mixes-animation`,e.innerHTML=`
    ...
    `,document.head.appendChild(e),()=>{e.remove()}},[]);let D=()=>{let e=t.current;if(!e)return null;if(r.current)return r.current;let n=window.AudioContext||window.webkitAudioContext;if(!n)return null;let o=new n,s=o.createAnalyser();s.fftSize=2048,s.smoothingTimeConstant=.78;let c=o.createMediaElementSource(e);return c.connect(s),s.connect(o.destination),r.current=o,i.current=s,a.current=c,o};(0,b.useEffect)(()=>{let e=n.current,t=i.current;if(!e||!t)return;let a=e.getContext(`2d`),c=new Uint8Array(t.frequencyBinCount),l=Array(64).fill(0),u=()=>{let n=e.width,i=e.height;a.clearRect(0,0,n,i),t.getByteFrequencyData(c);let d=25e3,f=(r.current?.sampleRate||44100)/t.fftSize,p=(n-126)/64;for(let e=0;e<64;e++){let t=16*(d/16)**(e/64),n=16*(d/16)**((e+1)/64),r=Math.floor(t/f),o=Math.max(r+1,Math.floor(n/f)),u=0,m=0;for(let e=r;e<o&&e<c.length;e++)u+=c[e],m++;let h=u/Math.max(m,1)/255;h=Math.min(h,.85)**2.4,l[e]+=((s?h:.05)-l[e])*.08;let g=i*(l[e]/(l[e]+.45))*.95,_=e*(p+2),v=i-g,y=a.createLinearGradient(0,v,0,i);y.addColorStop(0,`rgba(130,220,255,0.95)`),y.addColorStop(1,`rgba(80,130,255,0.15)`),a.fillStyle=y,a.fillRect(_,v,p,g)}o.current=requestAnimationFrame(u)};return u(),()=>{o.current&&cancelAnimationFrame(o.current)}},[s]),(0,b.useEffect)(()=>{let e=t.current;e&&(e.volume=d,e.muted=l)},[d,l]),(0,b.useEffect)(()=>{let e=t.current;if(!e)return;let n=()=>{g(e.currentTime||0)},r=()=>{Number.isFinite(e.duration)&&v(e.duration)};return e.addEventListener(`timeupdate`,n),e.addEventListener(`loadedmetadata`,r),e.addEventListener(`durationchange`,r),()=>{e.removeEventListener(`timeupdate`,n),e.removeEventListener(`loadedmetadata`,r),e.removeEventListener(`durationchange`,r)}},[p]),(0,b.useEffect)(()=>{let e=setInterval(()=>{S(88+Math.floor(Math.random()*10));let e=(1.1+Math.random()*1).toFixed(1);w(`${e}s`)},1800);return()=>clearInterval(e)},[]),(0,b.useEffect)(()=>{let e=t.current;e&&(e.src=E.file,e.load(),g(0),v(0),(async()=>{try{let t=D();t&&t.state===`suspended`&&await t.resume(),await e.play(),c(!0)}catch{c(!1)}})())},[p]);let O=()=>{m(e=>(e+1)%Ql.length)},k=async()=>{let e=t.current;if(e){if(s){e.pause(),c(!1);return}try{let t=D();t&&t.state===`suspended`&&await t.resume(),await e.play(),c(!0)}catch{c(!1)}}},A=e=>{let n=t.current;if(!n||!_)return;let r=Number(e.target.value);n.currentTime=r,g(r)},ee=e=>{m(t=>e<0?(t-1+Ql.length)%Ql.length:(t+1)%Ql.length)};return(0,x.jsxs)(`div`,{style:{width:`min(420px, 90vw)`,padding:`46px 26px 22px`,borderRadius:`24px`,background:`linear-gradient(145deg, rgba(9,15,27,.94), rgba(3,7,15,.97))`,border:`1px solid rgba(125,190,255,.20)`,boxShadow:`0 20px 70px rgba(0,0,0,.55), inset 0 0 40px rgba(70,150,255,.035)`,color:`#eaf4ff`,fontFamily:`Inter, system-ui, sans-serif`,backdropFilter:`blur(18px)`,position:`relative`},children:[(0,x.jsx)(`audio`,{ref:t,onEnded:O}),(0,x.jsx)(`button`,{onClick:e,"aria-label":`Close mixes`,style:{position:`absolute`,top:14,right:16,zIndex:5,border:`none`,background:`transparent`,color:`rgba(220,240,255,.62)`,fontSize:22,fontWeight:300,lineHeight:1,cursor:`pointer`,padding:`4px 7px`},children:`×`}),(0,x.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`flex-start`,marginBottom:22},children:[(0,x.jsxs)(`div`,{children:[(0,x.jsx)(`div`,{style:{fontSize:11,letterSpacing:`3px`,opacity:.55,marginBottom:7},children:`NYXTRYP`}),(0,x.jsx)(`div`,{style:{fontSize:21,letterSpacing:`4px`,fontWeight:500},children:`MIXES`.split(``).map((e,t)=>(0,x.jsx)(`span`,{style:{animation:`loriPulse ${1.6+t*.3}s ease-in-out infinite`,animationDelay:`${t*.35}s`},children:e},t))})]}),(0,x.jsxs)(`div`,{style:{textAlign:`right`,fontSize:9,letterSpacing:`1.5px`},children:[(0,x.jsx)(`div`,{style:{color:`#75d8ff`,marginBottom:6},children:`● MIX LINK`}),(0,x.jsx)(`div`,{style:{opacity:.5},children:`AUDIO RELAY`})]})]}),(0,x.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:8,marginBottom:18},children:[Array.from({length:12}).map((e,t)=>{let n=t<Math.round(y/8);return(0,x.jsx)(`div`,{style:{width:5,height:7+t*1.4,borderRadius:2,background:n?`#70d8ff`:`rgba(120,180,220,.12)`,boxShadow:n?`0 0 8px rgba(90,210,255,.5)`:`none`}},t)}),(0,x.jsxs)(`div`,{style:{marginLeft:`auto`,fontSize:9,letterSpacing:`1px`,opacity:.55},children:[y,`% · `,C]})]}),(0,x.jsx)(`div`,{style:{height:105,borderRadius:14,overflow:`hidden`,padding:`0 22px`,background:`rgba(0,0,0,.20)`,border:`1px solid rgba(100,180,255,.08)`,marginBottom:18},children:(0,x.jsx)(`canvas`,{ref:n,width:720,height:210,style:{width:`100%`,height:`100%`,display:`block`}})}),(0,x.jsx)(`div`,{style:{marginBottom:18},children:(0,x.jsx)(`div`,{style:{position:`relative`,overflow:`hidden`,width:`100%`,height:22,whiteSpace:`nowrap`},children:(0,x.jsx)(`div`,{style:{display:`inline-block`,whiteSpace:`nowrap`,animation:E.title.length>34?`mixTitleScroll 18s linear infinite`:`none`,paddingLeft:E.title.length>34?`100%`:0},children:E.title})})}),(0,x.jsxs)(`div`,{style:{marginBottom:18},children:[(0,x.jsx)(`input`,{type:`range`,min:`0`,max:_||0,step:`0.1`,value:Math.min(h,_||0),onChange:A,disabled:!_,style:{width:`100%`,accentColor:`#73d8ff`,cursor:_?`pointer`:`default`}}),(0,x.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,marginTop:5,fontSize:9,letterSpacing:`1px`,opacity:.42},children:[(0,x.jsx)(`span`,{children:$l(h)}),(0,x.jsx)(`span`,{children:$l(_)})]})]}),(0,x.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`center`,gap:12,marginBottom:16},children:[(0,x.jsx)(`button`,{onClick:()=>ee(-1),"aria-label":`Previous mix`,style:{width:38,height:38,borderRadius:`50%`,border:`1px solid rgba(120,210,255,.20)`,background:`rgba(80,170,255,.06)`,color:`#dff7ff`,cursor:`pointer`,fontSize:15},children:`‹`}),(0,x.jsx)(`button`,{onClick:k,style:{width:42,height:42,borderRadius:`50%`,border:`1px solid rgba(120,210,255,.28)`,background:`rgba(80,170,255,.08)`,color:`#dff7ff`,cursor:`pointer`,fontSize:16},children:s?`Ⅱ`:`▶`}),(0,x.jsx)(`button`,{onClick:()=>ee(1),"aria-label":`Next mix`,style:{width:38,height:38,borderRadius:`50%`,border:`1px solid rgba(120,210,255,.20)`,background:`rgba(80,170,255,.06)`,color:`#dff7ff`,cursor:`pointer`,fontSize:15},children:`›`})]}),(0,x.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:10},children:[(0,x.jsx)(`button`,{onClick:()=>u(e=>!e),style:{border:`none`,background:`transparent`,color:`rgba(220,240,255,.7)`,cursor:`pointer`,fontSize:16},children:l?`🔇`:`🔊`}),(0,x.jsx)(`input`,{type:`range`,min:`0`,max:`1`,step:`0.01`,value:d,onChange:e=>f(Number(e.target.value)),style:{flex:1,accentColor:`#73d8ff`}}),(0,x.jsx)(`span`,{style:{fontSize:9,opacity:.42,minWidth:28,textAlign:`right`},children:Math.round(d*100)})]})]})}var tu=[`After Midnight`,`Awaken The Machine`,`Beyond Reality`,`Beyond The Signal`,`Crystal Memory`,`Digital Paradise`,`Echoes Of Tomorrow`,`Electric Dreams`,`Electric Soul`,`Final Horizon`,`Future Is Calling`,`Gravity Of Light`,`Hidden Dimension`,`Higher State`,`Infinite Desire`,`Infinite Motion`,`Into The Unknown`,`Lost In Frequency`,`Neon Awakening`,`Night Protocol`,`Parallel Hearts`,`Silent Velocity`,`Synthetic Emotion`,`The Last Transmission`,`Zero Gravity`].map(e=>({title:`${e} — Nyxtryp`,file:`/media/tracks/${e} — Nyxtryp.mp3`})),nu=(e,t,n)=>Math.max(t,Math.min(n,e)),ru=e=>!Number.isFinite(e)||e<0?`0:00`:`${Math.floor(e/60)}:${String(Math.floor(e%60)).padStart(2,`0`)}`;function iu({channel:e,value:t}){let n=[[-30,-7.24],[-20,1.04],[-10,9.53],[-7,18.9],[-5,28.35],[-3,38.11],[-1,46.89],[0,52.23],[3,63.81],[5,76.4],[10,81.69]],r=(e=>{let t=nu(e,-30,10);for(let e=1;e<n.length;e++){let[r,i]=n[e],[a,o]=n[e-1];if(t<=r)return o+(i-o)*((t-a)/(r-a))}return n[n.length-1][1]})(t),i=e.toLowerCase();return(0,x.jsxs)(`svg`,{className:`nyx-meter-svg`,viewBox:`0 0 1080 600`,role:`img`,"aria-label":`${e} VU meter`,children:[(0,x.jsxs)(`defs`,{children:[(0,x.jsx)(`filter`,{id:`shadow-${i}`,children:(0,x.jsx)(`feDropShadow`,{dx:`3`,dy:`3`,stdDeviation:`8`,floodOpacity:`.5`})}),(0,x.jsxs)(`radialGradient`,{id:`meterBlue-${i}`,cx:`50%`,cy:`55%`,r:`72%`,children:[(0,x.jsx)(`stop`,{offset:`0%`,stopColor:`#5edbff`}),(0,x.jsx)(`stop`,{offset:`42%`,stopColor:`#159fe8`}),(0,x.jsx)(`stop`,{offset:`78%`,stopColor:`#0875c4`}),(0,x.jsx)(`stop`,{offset:`100%`,stopColor:`#043d73`})]}),(0,x.jsxs)(`filter`,{id:`blueGlow-${i}`,x:`-20%`,y:`-30%`,width:`140%`,height:`160%`,children:[(0,x.jsx)(`feGaussianBlur`,{stdDeviation:`9`,result:`blur`}),(0,x.jsx)(`feFlood`,{floodColor:`#38cfff`,floodOpacity:`.72`,result:`glowColor`}),(0,x.jsx)(`feComposite`,{in:`glowColor`,in2:`blur`,operator:`in`,result:`glow`}),(0,x.jsxs)(`feMerge`,{children:[(0,x.jsx)(`feMergeNode`,{in:`glow`}),(0,x.jsx)(`feMergeNode`,{in:`SourceGraphic`})]})]})]}),(0,x.jsx)(`rect`,{x:`0`,y:`0`,width:`1077`,height:`598`,fill:`url(#meterBlue-${i})`,filter:`url(#blueGlow-${i})`}),(0,x.jsx)(`path`,{d:`m537.18074,590.23438 a150.76556 150.76556 0 0 0 -107.3086 45.05078 l214.73829,0 a150.76556 150.76556 0 0 0 -107.42969,-45.05078 z`,fill:`#000`}),(0,x.jsxs)(`g`,{children:[(0,x.jsx)(`path`,{d:`m82,292 45.3061,0`,fill:`none`,stroke:`#000`,strokeWidth:`5`}),(0,x.jsx)(`path`,{d:`m948.30743,285.82189 45.3061,0`,fill:`none`,stroke:`#000`,strokeWidth:`5`}),(0,x.jsx)(`path`,{d:`m970.96048,263.16884 0,45.3061`,fill:`none`,stroke:`#000`,strokeWidth:`5`}),(0,x.jsx)(`path`,{d:`m657,277.24518 c85.60879,8.87328 173.21481,25.29511 295.97922,75.9692`,fill:`none`,stroke:`#f00`,strokeWidth:`15`}),(0,x.jsx)(`path`,{d:`m126.01626,357.7731 c161.49448,-60.14366 315.01211,-98.096 531.2366,-81.4418`,fill:`none`,stroke:`#000`,strokeWidth:`15`}),(0,x.jsx)(`path`,{d:`m210.72277,271.30126 34.37058 47.77511`,fill:`none`,stroke:`#000`,strokeWidth:`8`}),(0,x.jsx)(`path`,{d:`m285.65064,249.6478 27.49646 52.24328`,fill:`none`,stroke:`#000`,strokeWidth:`8`}),(0,x.jsx)(`path`,{d:`m365.73409,233.49363 18.56011 52.93069`,fill:`none`,stroke:`#000`,strokeWidth:`8`}),(0,x.jsx)(`path`,{d:`m451.66054,221.12022 8.93635 53.96181`,fill:`none`,stroke:`#000`,strokeWidth:`8`}),(0,x.jsx)(`path`,{d:`m544.1174,217.33945 -0.68741 53.96181`,fill:`none`,stroke:`#000`,strokeWidth:`8`}),(0,x.jsx)(`path`,{d:`m620.76379,220.0891 -8.59264 53.2744`,fill:`none`,stroke:`#000`,strokeWidth:`8`}),(0,x.jsx)(`path`,{d:`m669.22631,226.96322 -14.43565 56.36775`,fill:`none`,stroke:`#f00`,strokeWidth:`8`}),(0,x.jsx)(`path`,{d:`m777.83734,243.8048 -24.40311 48.80622`,fill:`none`,stroke:`#f00`,strokeWidth:`8`}),(0,x.jsx)(`path`,{d:`m864.4512,318.73266 34.37058 -43.65063`,fill:`none`,stroke:`#f00`,strokeWidth:`8`}),(0,x.jsx)(`g`,{transform:`rotate(${r} 537.57412 730.481)`,children:(0,x.jsx)(`path`,{d:`M184.04706,291.70923 537.57412,730.481`,fill:`none`,stroke:`#000`,strokeWidth:`6.7`,strokeLinecap:`butt`})}),(0,x.jsx)(`text`,{x:`492.73926`,y:`393.86093`,fontFamily:`Roboto,Arial,sans-serif`,fontSize:`60`,fontWeight:`900`,children:`VU`}),(0,x.jsx)(`text`,{x:`902.58594`,y:`255.49496`,fontSize:`40`,children:`5`}),(0,x.jsx)(`text`,{x:`775.54688`,y:`218.96762`,fontSize:`40`,children:`3`}),(0,x.jsx)(`text`,{x:`663.13672`,y:`202.96762`,fontSize:`40`,children:`0`}),(0,x.jsx)(`text`,{x:`612.89453`,y:`196.49496`,fontSize:`40`,children:`1`}),(0,x.jsx)(`text`,{x:`530.54688`,y:`194.96762`,fontSize:`40`,children:`3`}),(0,x.jsx)(`text`,{x:`439.58594`,y:`202.49496`,fontSize:`40`,children:`5`}),(0,x.jsx)(`text`,{x:`348.78125`,y:`210.49496`,fontSize:`40`,children:`7`}),(0,x.jsx)(`text`,{x:`251.89453`,y:`221.96762`,fontSize:`40`,children:`10`}),(0,x.jsx)(`text`,{x:`160.42969`,y:`243.96762`,fontSize:`40`,children:`20`})]})]})}function au({onClose:e}){let t=(0,b.useRef)(null),n=(0,b.useRef)(null),r=(0,b.useRef)(null),i=(0,b.useRef)(null);(0,b.useRef)(null);let a=(0,b.useRef)({left:-60,right:-60}),o=(0,b.useRef)(new Float32Array(64)),s=(0,b.useRef)(new Float32Array(64)),c=(0,b.useRef)(new Float32Array(64)),[l,u]=(0,b.useState)(0),[d,f]=(0,b.useState)(!1),[p,m]=(0,b.useState)(.68),[h,g]=(0,b.useState)(!1),[_,v]=(0,b.useState)(0),[y,S]=(0,b.useState)(0),[C,w]=(0,b.useState)(-60),[T,E]=(0,b.useState)(-60),[,D]=(0,b.useState)(0),O=tu[l];(0,b.useEffect)(()=>{let e=!1;return fetch(`/api/media`,{cache:`no-store`}).then(e=>e.ok?e.json():Promise.reject(Error(`media api failed`))).then(t=>{if(e||!Array.isArray(t.tracks)||!t.tracks.length)return;let n=t.tracks.map(e=>({title:e.replace(/\.mp3$/i,``),file:t.trackUrls?.[e]||`/media/tracks/${encodeURIComponent(e)}`}));tu.splice(0,tu.length,...n),D(e=>e+1)}).catch(()=>{}),()=>{e=!0}},[]);let k=async()=>{let e=t.current;if(!e)return null;if(r.current)return r.current.state===`suspended`&&await r.current.resume(),r.current;let n=window.AudioContext||window.webkitAudioContext;if(!n)return null;let a=new n,o=a.createMediaElementSource(e),s=a.createChannelSplitter(2),c=a.createAnalyser(),l=a.createAnalyser(),u=a.createAnalyser();return c.fftSize=l.fftSize=1024,u.fftSize=32768,c.smoothingTimeConstant=l.smoothingTimeConstant=0,u.smoothingTimeConstant=0,o.connect(s),s.connect(c,0),s.connect(l,1),s.connect(u,0),o.connect(a.destination),r.current=a,i.current={left:c,right:l,spectrum:u},a};(0,b.useEffect)(()=>{let e=t.current;if(!e)return;let n=d,r=!1;e.src=O.file,e.volume=p,e.muted=h,e.load(),v(0),S(0),a.current={left:-60,right:-60},w(-60),E(-60);let i=async()=>{if(!r)try{let t=await k();t?.state===`suspended`&&await t.resume(),await e.play(),r||f(!0)}catch{r||f(!1)}};return n?e.readyState>=3?i():e.addEventListener(`canplay`,i,{once:!0}):(e.pause(),f(!1)),()=>{r=!0,e.removeEventListener(`canplay`,i)}},[l]),(0,b.useEffect)(()=>{let e=t.current;e&&(e.volume=p,e.muted=h)},[p,h]),(0,b.useEffect)(()=>{let e=t.current;if(!e)return;let n=()=>v(e.currentTime||0),r=()=>Number.isFinite(e.duration)&&S(e.duration);return e.addEventListener(`timeupdate`,n),e.addEventListener(`loadedmetadata`,r),e.addEventListener(`durationchange`,r),()=>{e.removeEventListener(`timeupdate`,n),e.removeEventListener(`loadedmetadata`,r),e.removeEventListener(`durationchange`,r)}},[l]),(0,b.useEffect)(()=>{let e,t=()=>{let n=i.current,r=performance.now();if(n){let e=new Uint8Array(n.left.fftSize),i=new Uint8Array(n.right.fftSize);n.left.getByteTimeDomainData(e),n.right.getByteTimeDomainData(i);let o=e=>{let t=0;for(let n=0;n<e.length;n++){let r=(e[n]-128)/128;t+=r*r}return Math.sqrt(t/e.length)},s=o(e),c=o(i),l=e=>e<=1e-6?-60:nu(20*Math.log10(e),-60,0),u=e=>nu(e+12,-30,10),d=u(l(s)),f=u(l(c)),p=(e,t,n)=>{let r=t>e?.045:.32;return e+(t-e)*(1-Math.exp(-n/(r*1e3)))},m=nu(r-(t.lastTime||r),1,80);t.lastTime=r;let h=p(a.current.left,d,m),g=p(a.current.right,f,m);a.current={left:h,right:g},w(h),E(g)}else a.current={left:-60,right:-60},w(-60),E(-60);e=requestAnimationFrame(t)};return t(),()=>cancelAnimationFrame(e)},[d]),(0,b.useEffect)(()=>{let e=n.current;if(!e)return;let t,a=()=>{let n=e.getContext(`2d`),l=i.current,u=performance.now();if(n.clearRect(0,0,e.width,e.height),l){let t=l.spectrum,i=new Uint8Array(t.frequencyBinCount);t.getByteFrequencyData(i);let f=Math.min(25e3,(r.current?.sampleRate||44100)/2),p=(r.current?.sampleRate||44100)/2,m=nu(u-(a.lastTime||u),1,80);a.lastTime=u;let h=2.2,g=(e.width-24-h*63)/64,_=o.current,v=s.current,y=c.current,b=e.height-8,x=e.height*.86,S=Math.max(3,Math.min(8,e.width/150));for(let e=0;e<64;e++){let t=e/63,r=20*(f/20)**t,a=nu((i[Math.max(0,Math.min(i.length-1,Math.floor(r/p*i.length)))]/255)**.72*.72,0,1)*(.82+Math.sin(e*.73)*.045),o=_[e],s=a-o;v[e]+=s*(s>0?.19:.095)*(m/16.67),v[e]*=(e<12?.84:e<28?.78:e<46?.72:.66)**(m/16.67),_[e]=nu(o+v[e]*(m/16.67),0,1),_[e]<.0015&&(_[e]=0),_[e]>y[e]?y[e]=_[e]:y[e]=Math.max(_[e],y[e]-m/16.67*.0045);let c=Math.max(d?.002:.001,_[e]),l=Math.max(3,x*c),u=12+e*(g+h),C=b-l,w=190+e*1.65,T=n.createLinearGradient(0,C,0,b);T.addColorStop(0,`hsla(${w},100%,78%,.98)`),T.addColorStop(.28,`hsla(${w},100%,58%,.94)`),T.addColorStop(1,`hsla(${w},92%,35%,.86)`),n.save(),n.shadowBlur=10,n.shadowColor=`hsla(${w},100%,60%,.55)`,n.fillStyle=T,n.fillRect(u,C,g,l),n.shadowBlur=0,n.beginPath(),n.moveTo(u,C),n.lineTo(u+S,C-S*.7),n.lineTo(u+g+S,C-S*.7),n.lineTo(u+g,C),n.closePath(),n.fillStyle=`hsla(${w},100%,82%,.88)`,n.fill(),n.beginPath(),n.moveTo(u+g,C),n.lineTo(u+g+S,C-S*.7),n.lineTo(u+g+S,b-S*.7),n.lineTo(u+g,b),n.closePath(),n.fillStyle=`hsla(${w},90%,30%,.9)`,n.fill(),n.fillStyle=`hsla(${w},100%,92%,.7)`,n.fillRect(u+1,C+1,Math.max(1,g-2),Math.min(2,l));let E=b-Math.max(3,x*y[e])-5;n.shadowBlur=8,n.shadowColor=`hsla(${w},100%,72%,.9)`,n.fillStyle=`hsla(${w},100%,88%,.98)`,n.fillRect(u-1,E,g+2,2.2),n.restore()}n.save(),n.globalAlpha=.18,n.strokeStyle=`#8adfff`,n.lineWidth=1;for(let t=1;t<5;t++){let r=b-e.height*.86*(t/5);n.beginPath(),n.moveTo(8,r),n.lineTo(e.width-8,r),n.stroke()}n.restore()}t=requestAnimationFrame(a)};return a(),()=>cancelAnimationFrame(t)},[d]);let A=async()=>{let e=t.current;if(e)try{let t=await k();t?.state===`suspended`&&await t.resume(),await e.play(),f(!0)}catch{f(!1)}},ee=()=>{d?(t.current?.pause(),f(!1)):A()},j=e=>u(t=>(t+e+tu.length)%tu.length);return(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`style`,{children:`
    ...
    `}),(0,x.jsx)(`div`,{className:`tracks-overlay`,onPointerDown:t=>t.pointerType===`mouse`&&e(),children:(0,x.jsxs)(`div`,{className:`tracks-window`,onPointerDown:e=>e.stopPropagation(),onClick:e=>e.stopPropagation(),children:[(0,x.jsx)(`audio`,{ref:t,onEnded:()=>j(1)}),(0,x.jsx)(`button`,{className:`tracks-close`,onClick:e,children:`×`}),(0,x.jsxs)(`div`,{className:`tracks-brand`,children:[(0,x.jsx)(`span`,{children:`NYXTRYP`}),(0,x.jsx)(`span`,{className:`tracks-brand-pulse`,children:`TRACK`})]}),(0,x.jsxs)(`div`,{className:`nyx-vu`,children:[(0,x.jsx)(`div`,{className:`nyx-meter`,children:(0,x.jsx)(iu,{channel:`L`,value:C})}),(0,x.jsx)(`div`,{className:`nyx-meter`,children:(0,x.jsx)(iu,{channel:`R`,value:T})})]}),(0,x.jsx)(`canvas`,{ref:n,className:`tracks-visualizer`,width:`1200`,height:`240`}),(0,x.jsxs)(`div`,{className:`tracks-controls`,children:[(0,x.jsx)(`button`,{className:`tracks-button`,onClick:()=>j(-1),children:`‹`}),(0,x.jsx)(`button`,{className:`tracks-button main`,onClick:ee,children:d?`Ⅱ`:`▶`}),(0,x.jsx)(`button`,{className:`tracks-button`,onClick:()=>j(1),children:`›`})]}),(0,x.jsxs)(`div`,{className:`tracks-progress`,children:[(0,x.jsx)(`span`,{children:ru(_)}),(0,x.jsx)(`input`,{type:`range`,min:`0`,max:y||0,step:`.1`,value:Math.min(_,y||0),onChange:e=>{let n=Number(e.target.value);t.current&&(t.current.currentTime=n),v(n)}}),(0,x.jsx)(`span`,{children:ru(y)})]}),(0,x.jsxs)(`div`,{className:`tracks-volume`,children:[(0,x.jsx)(`button`,{className:`tracks-button`,onClick:()=>g(e=>!e),children:h?`🔇`:`🔊`}),(0,x.jsx)(`input`,{type:`range`,min:`0`,max:`1`,step:`.01`,value:p,onChange:e=>m(Number(e.target.value))})]}),(0,x.jsx)(`div`,{className:`tracks-playlist`,children:tu.map((e,t)=>(0,x.jsxs)(`button`,{className:`tracks-item${t===l?` active`:``}`,onClick:()=>{u(t),setTimeout(A,100)},children:[(0,x.jsx)(`span`,{className:`tracks-number`,children:String(t+1).padStart(2,`0`)}),(0,x.jsx)(`span`,{className:`tracks-item-title`,children:e.title})]},e.file))})]})})]})}function ou(){let[e,t]=(0,b.useState)(!1),[n,r]=(0,b.useState)(!1),[i,a]=(0,b.useState)(!1),[o,s]=(0,b.useState)(!1);return(0,x.jsx)(`div`,{className:`scene`,children:e?(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(S,{}),(0,x.jsx)(Jl,{onRadioOpen:()=>r(!0),onMixesOpen:()=>a(!0),onTracksOpen:()=>s(!0)}),n&&(0,x.jsx)(`div`,{onPointerDown:e=>{e.pointerType===`mouse`&&r(!1)},style:{position:`fixed`,inset:0,zIndex:100,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`rgba(0,0,0,.10)`,backdropFilter:`blur(2px)`,cursor:`default`},children:(0,x.jsx)(`div`,{onClick:e=>e.stopPropagation(),onPointerDown:e=>e.stopPropagation(),style:{position:`relative`,zIndex:101},children:(0,x.jsx)(Zl,{onClose:()=>r(!1)})})}),o&&(0,x.jsx)(`div`,{onPointerDown:e=>{e.pointerType===`mouse`&&s(!1)},style:{position:`fixed`,inset:0,zIndex:100,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`rgba(0,0,0,.10)`,backdropFilter:`blur(2px)`,cursor:`default`},children:(0,x.jsx)(`div`,{onClick:e=>e.stopPropagation(),onPointerDown:e=>e.stopPropagation(),style:{position:`relative`,zIndex:101},children:(0,x.jsx)(au,{onClose:()=>s(!1)})})}),i&&(0,x.jsx)(`div`,{onPointerDown:e=>{e.pointerType===`mouse`&&a(!1)},style:{position:`fixed`,inset:0,zIndex:100,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`rgba(0,0,0,.10)`,backdropFilter:`blur(2px)`,cursor:`default`},children:(0,x.jsx)(`div`,{onClick:e=>e.stopPropagation(),onPointerDown:e=>e.stopPropagation(),style:{position:`relative`,zIndex:101},children:(0,x.jsx)(eu,{onClose:()=>a(!1)})})})]}):(0,x.jsxs)(`section`,{className:`intro`,children:[(0,x.jsx)(`p`,{className:`artist`,children:`NYXTRYP`}),(0,x.jsx)(`h1`,{children:`DON'T LISTEN. ENTER.`}),(0,x.jsx)(`button`,{className:`enter-button`,onClick:()=>t(!0),children:`ENTER`})]})})}var su=[{id:`tracks`,label:`TRACKS`,accept:`audio/*`,icon:`♪`,kind:`AUDIO`},{id:`radio`,label:`RADIO`,accept:`audio/*`,icon:`◉`,kind:`AUDIO`},{id:`mixes`,label:`MIXES`,accept:`audio/*`,icon:`◒`,kind:`AUDIO`},{id:`photos`,label:`PHOTOS`,accept:`image/*`,icon:`▧`,kind:`IMAGE`}],cu=e=>e.replace(/\.[^.]+$/,``),lu=e=>(e.match(/\.[^.]+$/)||[``])[0];async function uu(e){let t=2936012.8;if(e.size<=t)return{file:e,name:e.name};let n=null,r=null;try{`createImageBitmap`in window?n=await createImageBitmap(e):(r=URL.createObjectURL(e),n=await new Promise((t,n)=>{let i=new Image,a=setTimeout(()=>n(Error(`Изображение слишком долго готовится`)),8e3);i.onload=()=>{clearTimeout(a),t(i)},i.onerror=()=>{clearTimeout(a),n(Error(`Не удалось прочитать изображение «${e.name}»`))},i.src=r}));let i=n.width||n.naturalWidth,a=n.height||n.naturalHeight;if(!i||!a)throw Error(`Не удалось определить размер изображения «${e.name}»`);let o=Math.min(1,2400/Math.max(i,a)),s=Math.max(1,Math.round(i*o)),c=Math.max(1,Math.round(a*o)),l=document.createElement(`canvas`);l.width=s,l.height=c;let u=l.getContext(`2d`);if(!u)throw Error(`Не удалось подготовить изображение`);u.drawImage(n,0,0,s,c),n.close&&n.close(),r&&URL.revokeObjectURL(r),r=null;let d=e=>new Promise((t,n)=>{l.toBlob(e=>e?t(e):n(Error(`Не удалось сжать изображение`)),`image/jpeg`,e)}),f=.88,p=await d(f);for(;p.size>t&&f>.55;)f-=.07,p=await d(f);if(p.size>t)throw Error(`«${e.name}» не удалось уменьшить до допустимого размера`);let m=cu(e.name).trim()||`photo`;return{file:new File([p],`${m}.jpg`,{type:`image/jpeg`}),name:`${m}.jpg`}}catch(e){throw n?.close&&n.close(),r&&URL.revokeObjectURL(r),e}}function du(e,t){return(lu(e).replace(`.`,``)||(t===`photos`?`image`:`audio`)).toUpperCase()}function fu(){let[e,t]=(0,b.useState)(()=>sessionStorage.getItem(`nyxtryp-admin-key`)||``),[n,r]=(0,b.useState)(!1),[i,a]=(0,b.useState)(`tracks`),[o,s]=(0,b.useState)({tracks:[],radio:[],mixes:[],photos:[]}),[c,l]=(0,b.useState)(!1),[u,d]=(0,b.useState)(``),[f,p]=(0,b.useState)(``),[m,h]=(0,b.useState)(null),[g,_]=(0,b.useState)(null),[v,y]=(0,b.useState)(null),[S,C]=(0,b.useState)(``),[w,T]=(0,b.useState)(`name`),[E,D]=(0,b.useState)(null),[O,k]=(0,b.useState)(null),[A,ee]=(0,b.useState)(!1),[j,te]=(0,b.useState)(``),[ne,re]=(0,b.useState)(``),[M,N]=(0,b.useState)(``),[P,ie]=(0,b.useState)({}),ae=(0,b.useRef)(null),F=(0,b.useMemo)(()=>su.find(e=>e.id===i),[i]),oe=async()=>{try{let t=await fetch(`/api/admin`,{cache:`no-store`,headers:{"X-Admin-Key":e.trim()}}),n=await t.json();if(!t.ok)throw Error(n.error||`Не удалось загрузить список`);s(n),r(!0),p(``)}catch(e){r(!1),p(e.message||`Ошибка подключения`)}};(0,b.useEffect)(()=>{let e=sessionStorage.getItem(`nyxtryp-admin-key`);e&&(async()=>{try{if(!(await fetch(`/api/admin`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({action:`auth`,adminKey:e})})).ok)throw Error(`Неверный admin key`);await oe()}catch{sessionStorage.removeItem(`nyxtryp-admin-key`),t(``),r(!1)}})()},[]);let I=async(t,n)=>{let r=await fetch(`/api/admin`,{method:t,headers:{"Content-Type":`application/json`},body:JSON.stringify({...n,adminKey:e})}),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(i.error||`Ошибка ${r.status}`);return i},L=async t=>{if(t.preventDefault(),e.trim()){d(`ПРОВЕРКА…`),p(``);try{await I(`POST`,{action:`auth`}),sessionStorage.setItem(`nyxtryp-admin-key`,e.trim()),await oe(),d(``)}catch(e){r(!1),p(e.message||`Неверный admin key`),d(``)}}},se=()=>{sessionStorage.removeItem(`nyxtryp-admin-key`),t(``),r(!1)},ce=async e=>{if(e.preventDefault(),p(``),d(``),!j||!ne||!M){p(`ЗАПОЛНИТЕ ВСЕ ПОЛЯ`);return}if(ne.length<8){p(`ПАРОЛЬ: МИНИМУМ 8 СИМВОЛОВ`);return}if(ne!==M){p(`ПАРОЛИ НЕ СОВПАДАЮТ`);return}l(!0);try{let e=await fetch(`/api/admin/password`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({adminKey:j,newKey:ne})}),n=await e.json().catch(()=>({}));if(!e.ok)throw Error(n.error||`ОШИБКА ${e.status}`);sessionStorage.removeItem(`nyxtryp-admin-key`),t(``),r(!1),ee(!1),te(``),re(``),N(``),d(``)}catch(e){p(e.message||`ОШИБКА СМЕНЫ ПАРОЛЯ`)}finally{l(!1)}},le=e=>{y(e||null),d(`ВЫБЕРИТЕ ФАЙЛ…`),p(``),h(null),ae.current&&(ae.current.value=``),requestAnimationFrame(()=>ae.current?.click())},ue=async t=>{let n=t.currentTarget,r=Array.from(n.files||[]);if(!r.length){d(`ФАЙЛ НЕ ВЫБРАН`);return}l(!0),p(``),h({total:r.length,current:0,step:`prepare`,name:r[0].name}),d(`1/4 · ПОДГОТОВКА`);try{for(let t=0;t<r.length;t+=1){let n=r[t];if(h({total:r.length,current:t+1,step:`prepare`,name:n.name}),d(`${t+1}/${r.length} · ПОДГОТОВКА`),i!==`photos`){let a=v||n.name;h({total:r.length,current:t+1,step:`send`,name:a}),d(`${t+1}/${r.length} · ОТПРАВКА В STORAGE`),await pu(n,i,a,e,e=>{h({total:r.length,current:t+1,step:`send`,name:a,percentage:e}),d(`${t+1}/${r.length} · ЗАГРУЗКА ${e}%`)}),h({total:r.length,current:t+1,step:`done`,name:a}),d(`${t+1}/${r.length} · СОХРАНЕНО`);continue}let a=await uu(n),o=a.file,s=v||a.name;h({total:r.length,current:t+1,step:`send`,name:s}),d(`${t+1}/${r.length} · ОТПРАВКА В STORAGE`),await pu(o,i,s,e,e=>{h({total:r.length,current:t+1,step:`send`,name:s,percentage:e}),d(`${t+1}/${r.length} · ЗАГРУЗКА ${e}%`)}),h({total:r.length,current:t+1,step:`done`,name:s}),d(`${t+1}/${r.length} · СОХРАНЕНО`)}y(null),h({total:r.length,current:r.length,step:`done`,name:r[r.length-1].name}),await oe(),d(r.length>1?`ГОТОВО · СОХРАНЕНО ${r.length}`:`ГОТОВО · ФАЙЛ СОХРАНЁН`)}catch(e){p(e.message||`Ошибка сохранения`),d(`ОШИБКА ЗАГРУЗКИ`)}finally{l(!1),n.value=``}},de=async e=>{D(null),l(!0),p(``),d(`УДАЛЕНИЕ…`);try{await I(`DELETE`,{type:i,name:e}),await oe(),d(`УДАЛЕНО`)}catch(e){p(e.message||`Ошибка удаления`),d(``)}finally{l(!1)}},fe=async()=>{if(g?.newName.trim()){l(!0),p(``),d(`ПЕРЕИМЕНОВАНИЕ…`);try{await I(`PATCH`,{type:i,oldName:g.oldName,newName:`${g.newName.trim()}${lu(g.oldName)}`}),_(null),await oe(),d(`ИМЯ ИЗМЕНЕНО`)}catch(e){p(e.message||`Ошибка переименования`),d(``)}finally{l(!1)}}},pe=(0,b.useMemo)(()=>{let e=o[i]||[];return[...S.trim()?e.filter(e=>e.toLowerCase().includes(S.trim().toLowerCase())):e].sort((e,t)=>w===`name`?e.localeCompare(t,void 0,{numeric:!0,sensitivity:`base`}):w===`type`?du(e,i).localeCompare(du(t,i))||e.localeCompare(t):0)},[o,i,S,w]);if((0,b.useEffect)(()=>{if(i!==`photos`)return;let e={};(o.photos||[]).forEach(t=>{e[t]=`/media/photos/${encodeURIComponent(t)}`}),ie(e)},[i,o.photos]),!n)return(0,x.jsxs)(`div`,{className:`nyx-admin-shell`,children:[(0,x.jsx)(`style`,{children:mu}),(0,x.jsxs)(`form`,{className:`nyx-admin-login`,onSubmit:L,children:[(0,x.jsx)(`div`,{className:`brand-mark`,children:`NYX`}),(0,x.jsx)(`div`,{className:`kicker`,children:`NYXTRYP / PRIVATE`}),(0,x.jsx)(`h1`,{children:`MEDIA CONTROL`}),(0,x.jsx)(`div`,{className:`sub`,children:`ADMIN ACCESS`}),(0,x.jsx)(`input`,{autoFocus:!0,type:`password`,value:e,onChange:e=>t(e.target.value),placeholder:`Admin key`}),(0,x.jsx)(`button`,{disabled:c,children:c?`CHECKING…`:`ENTER`}),u&&(0,x.jsx)(`p`,{className:`status`,children:u}),f&&(0,x.jsx)(`p`,{className:`err`,children:f})]})]});let me=o[i]?.length||0,he=m?.step||``;return(0,x.jsxs)(`div`,{className:`nyx-admin-shell`,children:[(0,x.jsx)(`style`,{children:mu}),(0,x.jsxs)(`main`,{className:`nyx-admin-panel`,children:[(0,x.jsxs)(`header`,{className:`topbar`,children:[(0,x.jsxs)(`div`,{className:`brand-block`,children:[(0,x.jsx)(`div`,{className:`brand-mark`,children:`NYX`}),(0,x.jsxs)(`div`,{children:[(0,x.jsx)(`div`,{className:`kicker`,children:`NYXTRYP / PRIVATE`}),(0,x.jsx)(`h1`,{children:`MEDIA CONTROL`}),(0,x.jsx)(`p`,{children:`CONTENT MANAGEMENT`})]})]}),(0,x.jsxs)(`div`,{style:{display:`flex`,gap:`7px`},children:[(0,x.jsx)(`button`,{className:`plain`,disabled:c,onClick:()=>{ee(!0),p(``),d(``)},children:`PASSWORD`}),(0,x.jsxs)(`button`,{className:`plain exit`,disabled:c,onClick:se,children:[`EXIT `,(0,x.jsx)(`span`,{children:`↗`})]})]})]}),(0,x.jsxs)(`section`,{className:`overview`,children:[(0,x.jsxs)(`div`,{children:[(0,x.jsx)(`div`,{className:`section-label`,children:`MEDIA LIBRARY`}),(0,x.jsxs)(`div`,{className:`headline`,children:[`YOUR UNIVERSE, `,(0,x.jsx)(`span`,{children:`ORGANIZED.`})]})]}),(0,x.jsxs)(`div`,{className:`total`,children:[(0,x.jsx)(`strong`,{children:Object.values(o).reduce((e,t)=>e+(t?.length||0),0)}),(0,x.jsx)(`span`,{children:`TOTAL FILES`})]})]}),(0,x.jsx)(`nav`,{className:`tabs`,children:su.map(e=>(0,x.jsxs)(`button`,{className:i===e.id?`active`:``,onClick:()=>{a(e.id),d(``),p(``),h(null),C(``),T(`name`)},children:[(0,x.jsx)(`i`,{children:e.icon}),(0,x.jsx)(`span`,{children:e.label}),(0,x.jsx)(`b`,{children:o[e.id]?.length||0})]},e.id))}),(0,x.jsxs)(`section`,{className:`toolbar`,children:[(0,x.jsxs)(`button`,{className:`add`,disabled:c,onClick:()=>le(null),children:[(0,x.jsx)(`span`,{children:`＋`}),i===`photos`?`UPLOAD PHOTOS`:`ADD ${F.label.slice(0,-1)}`]}),(0,x.jsxs)(`div`,{className:`search`,children:[(0,x.jsx)(`span`,{children:`⌕`}),(0,x.jsx)(`input`,{value:S,onChange:e=>C(e.target.value),placeholder:`SEARCH ${F.label.toLowerCase()}…`}),S&&(0,x.jsx)(`button`,{onClick:()=>C(``),children:`×`})]}),(0,x.jsxs)(`select`,{value:w,onChange:e=>T(e.target.value),"aria-label":`Sort files`,children:[(0,x.jsx)(`option`,{value:`name`,children:`NAME`}),(0,x.jsx)(`option`,{value:`type`,children:`TYPE`})]})]}),(0,x.jsx)(`input`,{ref:ae,className:`upload-input`,id:`nyx-media-upload`,type:`file`,accept:F.accept,multiple:i===`photos`,onChange:ue}),m&&(0,x.jsxs)(`section`,{className:`upload-progress`,children:[(0,x.jsxs)(`div`,{className:`progress-head`,children:[(0,x.jsxs)(`div`,{children:[(0,x.jsx)(`div`,{className:`kicker`,children:`UPLOAD PROCESS`}),(0,x.jsx)(`strong`,{children:m.name})]}),(0,x.jsx)(`span`,{children:m.total>1?`${m.current}/${m.total}`:he.toUpperCase()})]}),(0,x.jsxs)(`div`,{className:`progress-steps`,children:[(0,x.jsxs)(`div`,{className:[`prepare`,`encode`,`send`,`done`].indexOf(he)>=0?`done`:``,children:[(0,x.jsx)(`b`,{children:`1`}),(0,x.jsx)(`span`,{children:`PREPARE`})]}),(0,x.jsx)(`i`,{}),(0,x.jsxs)(`div`,{className:[`encode`,`send`,`done`].indexOf(he)>=0?`done`:``,children:[(0,x.jsx)(`b`,{children:`2`}),(0,x.jsx)(`span`,{children:`READ`})]}),(0,x.jsx)(`i`,{}),(0,x.jsxs)(`div`,{className:[`send`,`done`].indexOf(he)>=0?`done`:``,children:[(0,x.jsx)(`b`,{children:`3`}),(0,x.jsx)(`span`,{children:`SEND`})]}),(0,x.jsx)(`i`,{}),(0,x.jsxs)(`div`,{className:he===`done`?`done`:``,children:[(0,x.jsx)(`b`,{children:`4`}),(0,x.jsx)(`span`,{children:`DONE`})]})]}),u&&(0,x.jsx)(`div`,{className:`progress-status`,children:u}),f&&(0,x.jsx)(`div`,{className:`progress-error`,children:f})]}),(0,x.jsx)(`section`,{className:`media-grid`,children:pe.map(e=>(0,x.jsxs)(`article`,{className:`media-card`,children:[i===`photos`?(0,x.jsx)(`button`,{className:`thumb`,onClick:()=>k(P[e]),children:(0,x.jsx)(`img`,{src:P[e],alt:e})}):(0,x.jsx)(`div`,{className:`audio-icon`,children:F.icon}),(0,x.jsxs)(`div`,{className:`media-info`,children:[(0,x.jsx)(`strong`,{title:e,children:e}),(0,x.jsxs)(`span`,{children:[du(e,i),` · `,me,` TOTAL`]})]}),(0,x.jsxs)(`div`,{className:`media-actions`,children:[(0,x.jsx)(`button`,{className:`plain`,disabled:c,onClick:()=>_({oldName:e,newName:cu(e)}),children:`RENAME`}),(0,x.jsx)(`button`,{className:`danger`,disabled:c,onClick:()=>D(e),children:`DELETE`}),i!==`photos`&&(0,x.jsx)(`button`,{className:`plain`,disabled:c,onClick:()=>le(e),children:`REPLACE`})]})]},e))}),pe.length===0&&(0,x.jsx)(`div`,{className:`empty`,children:`NO FILES FOUND`}),g&&(0,x.jsx)(`div`,{className:`modal-backdrop`,children:(0,x.jsxs)(`form`,{className:`modal`,onSubmit:e=>{e.preventDefault(),fe()},children:[(0,x.jsx)(`div`,{className:`kicker`,children:`EDIT MEDIA`}),(0,x.jsx)(`h2`,{children:`RENAME FILE`}),(0,x.jsx)(`input`,{autoFocus:!0,value:g.newName,onChange:e=>_({...g,newName:e.target.value})}),(0,x.jsxs)(`div`,{className:`modal-actions`,children:[(0,x.jsx)(`button`,{type:`button`,className:`plain`,onClick:()=>_(null),children:`CANCEL`}),(0,x.jsx)(`button`,{type:`submit`,disabled:c,children:`SAVE`})]})]})}),A&&(0,x.jsx)(`div`,{className:`modal-backdrop`,children:(0,x.jsxs)(`form`,{className:`modal`,onSubmit:ce,children:[(0,x.jsx)(`div`,{className:`kicker`,children:`SECURITY`}),(0,x.jsx)(`h2`,{children:`CHANGE PASSWORD`}),(0,x.jsx)(`input`,{autoFocus:!0,type:`password`,value:j,onChange:e=>te(e.target.value),placeholder:`CURRENT PASSWORD`}),(0,x.jsx)(`input`,{type:`password`,value:ne,onChange:e=>re(e.target.value),placeholder:`NEW PASSWORD`,style:{marginTop:`7px`}}),(0,x.jsx)(`input`,{type:`password`,value:M,onChange:e=>N(e.target.value),placeholder:`CONFIRM PASSWORD`,style:{marginTop:`7px`}}),f&&(0,x.jsx)(`p`,{className:`err`,children:f}),(0,x.jsxs)(`div`,{className:`modal-actions`,children:[(0,x.jsx)(`button`,{type:`button`,className:`plain`,disabled:c,onClick:()=>{ee(!1),te(``),re(``),N(``),p(``)},children:`CANCEL`}),(0,x.jsx)(`button`,{type:`submit`,disabled:c,children:c?`SAVING…`:`CHANGE`})]})]})}),E&&(0,x.jsx)(`div`,{className:`modal-backdrop`,children:(0,x.jsxs)(`div`,{className:`modal`,children:[(0,x.jsx)(`div`,{className:`kicker`,children:`DANGER ZONE`}),(0,x.jsx)(`h2`,{children:`DELETE FILE?`}),(0,x.jsx)(`p`,{children:E}),(0,x.jsxs)(`div`,{className:`modal-actions`,children:[(0,x.jsx)(`button`,{className:`plain`,onClick:()=>D(null),children:`CANCEL`}),(0,x.jsx)(`button`,{className:`danger`,disabled:c,onClick:()=>de(E),children:`DELETE`})]})]})}),O&&(0,x.jsx)(`div`,{className:`modal-backdrop photo-modal`,onClick:()=>k(null),children:(0,x.jsx)(`img`,{src:O,alt:`Preview`})}),(0,x.jsxs)(`footer`,{children:[(0,x.jsxs)(`span`,{children:[me,` FILES`]}),(0,x.jsx)(`span`,{children:`VDS STORAGE`}),(0,x.jsx)(`span`,{children:`VIA NYXTRYP ADMIN`})]})]})]})}var pu=(e,t,n,r,i)=>new Promise((a,o)=>{let s=new XMLHttpRequest;s.open(`POST`,`/api/upload?type=${encodeURIComponent(t)}&name=${encodeURIComponent(n)}`),s.setRequestHeader(`X-Admin-Key`,r),s.setRequestHeader(`Content-Type`,e.type||`application/octet-stream`),s.upload.onprogress=e=>{e.lengthComputable&&i&&i(Math.round(e.loaded/e.total*100))},s.onload=()=>{let e={};try{e=JSON.parse(s.responseText||`{}`)}catch{}s.status>=200&&s.status<300?a(e):o(Error(e.error||`Ошибка ${s.status}`))},s.onerror=()=>o(Error(`Ошибка соединения`)),s.send(e)}),mu=`
...
`;function hu(){let e=document.getElementById(`nyxtryp-photos-window`);e&&e.remove();let t=[];fetch(`/api/media`,{cache:`no-store`}).then(e=>e.ok?e.json():Promise.reject(Error(`media api failed`))).then(e=>{!Array.isArray(e.photos)||!e.photos.length||(t.splice(0,t.length,...e.photos.map(e=>`/media/photos/${encodeURIComponent(e)}`)),h(),n=Math.min(n,t.length-1),m())}).catch(()=>{});let n=0,r=document.body.style.overflow;document.body.style.overflow=`hidden`;let i=document.createElement(`div`);i.id=`nyxtryp-photos-window`,Object.assign(i.style,{position:`fixed`,inset:`0`,width:`100vw`,height:`100dvh`,zIndex:`2147483647`,background:`rgba(0,0,0,0.98)`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,overflow:`hidden`,isolation:`isolate`});let a=()=>{i.remove(),document.body.style.overflow=r,window.removeEventListener(`keydown`,_)},o=document.createElement(`button`);o.textContent=`×`,Object.assign(o.style,{position:`absolute`,right:`20px`,top:`10px`,zIndex:`20`,border:`0`,background:`transparent`,color:`#fff`,fontSize:`36px`,cursor:`pointer`}),o.onclick=a,i.appendChild(o);let s=document.createElement(`div`);Object.assign(s.style,{position:`relative`,width:`100%`,flex:`1`,minHeight:`0`,display:`flex`,alignItems:`center`,justifyContent:`center`,padding:`40px 65px 15px`,boxSizing:`border-box`});let c=document.createElement(`img`);Object.assign(c.style,{maxWidth:`100%`,maxHeight:`100%`,width:`auto`,height:`auto`,objectFit:`contain`,userSelect:`none`}),c.draggable=!1,s.appendChild(c);let l=(e,t)=>{let n=document.createElement(`button`);return n.textContent=e,Object.assign(n.style,{position:`absolute`,top:`50%`,[t]:`10px`,transform:`translateY(-50%)`,width:`46px`,height:`80px`,border:`0`,background:`transparent`,color:`#fff`,fontSize:`40px`,cursor:`pointer`,zIndex:`10`}),n},u=l(`‹`,`left`),d=l(`›`,`right`);s.appendChild(u),s.appendChild(d),i.appendChild(s);let f=document.createElement(`div`);Object.assign(f.style,{width:`100%`,height:`90px`,flexShrink:`0`,display:`flex`,alignItems:`center`,gap:`8px`,overflowX:`auto`,overflowY:`hidden`,padding:`8px 16px 14px`,boxSizing:`border-box`}),i.appendChild(f);let p=[],m=()=>{t.length&&(c.src=t[n],p.forEach((e,t)=>{e.style.opacity=t===n?`1`:`0.45`,e.style.borderColor=t===n?`rgba(255,255,255,0.95)`:`rgba(255,255,255,0.25)`}),p[n]&&p[n].scrollIntoView({behavior:`smooth`,block:`nearest`,inline:`center`}))},h=()=>{f.innerHTML=``,p.length=0,t.forEach((e,t)=>{let r=document.createElement(`button`);Object.assign(r.style,{flex:`0 0 72px`,width:`72px`,height:`62px`,padding:`0`,border:`1px solid rgba(255,255,255,0.25)`,background:`#080808`,overflow:`hidden`,cursor:`pointer`,opacity:`0.45`});let i=document.createElement(`img`);i.src=e,Object.assign(i.style,{width:`100%`,height:`100%`,objectFit:`cover`,display:`block`}),r.appendChild(i),r.onclick=()=>{n=t,m()},f.appendChild(r),p.push(r)})};h(),u.onclick=()=>{t.length&&(n=(n-1+t.length)%t.length,m())},d.onclick=()=>{t.length&&(n=(n+1)%t.length,m())};let g=0;s.addEventListener(`touchstart`,e=>{e.touches.length&&(g=e.touches[0].clientX)},{passive:!0}),s.addEventListener(`touchend`,e=>{if(!e.changedTouches.length||!t.length)return;let r=e.changedTouches[0].clientX-g;Math.abs(r)>50&&(n=r<0?(n+1)%t.length:(n-1+t.length)%t.length,m())},{passive:!0});let _=e=>{!document.body.contains(i)||!t.length||(e.key===`ArrowLeft`&&(n=(n-1+t.length)%t.length,m()),e.key===`ArrowRight`&&(n=(n+1)%t.length,m()),e.key===`Escape`&&a())};window.addEventListener(`keydown`,_),document.body.appendChild(i),m()}var gu=[[`WEBSITE`,`https://nyxtryp.vercel.app`],[`TELEGRAM`,`https://t.me/nyxtryp`],[`YOUTUBE`,`https://www.youtube.com/@nyxtryp`],[`TIKTOK`,`https://www.tiktok.com/@nyxtryp`],[`INSTAGRAM`,`https://www.instagram.com/nyxtryp/`]],_u=[[`01`,`AUDIO`],[`02`,`VIDEO`],[`03`,`GUESTBOOK`],[`04`,`VISUAL`],[`05`,`SOCIAL`],[`06`,`RELEASES`],[`07`,`PHOTOS`],[`08`,`ABOUT`]],vu={ru:{project:`НЕЗАВИСИМЫЙ ЭЛЕКТРОННЫЙ ПРОЕКТ`,tag:`ВОЙДИ В НЕИЗВЕДАННОЕ.`,note:`ОТКРОЙТЕ ВЕБ-ВЕРСИЮ. ВОЙДИТЕ ВО ВСЕЛЕННУЮ.`,enter:`ВОЙТИ`,meta:`ЭЛЕКТРОНИКА / ПОГРУЖЕНИЕ`,world:`NYXTRYP / МИР`,genres:`ТРАНС · ПСАЙТРАНС · АТМОСФЕРА · ДВИЖЕНИЕ`,footer:`ОТКРОЙТЕ ВЕБ-ВЕРСИЮ / ВСЕЛЕННАЯ DESKTOP`,headerInfo:`ПОЛНАЯ ВЕРСИЯ САЙТА ДОСТУПНА ТОЛЬКО С КОМПЬЮТЕРА ИЛИ НОУТБУКА · С УВАЖЕНИЕМ, NYXTRYP`,bottomInfo:`ЭТОТ МИР СОЗДАН ДЛЯ ТЕХ, КТО ЛЮБИТ СЛУШАТЬ, СМОТРЕТЬ И ИССЛЕДОВАТЬ.`,copyright:`© 2026 NYXTRYP MUSIC · ВСЕ ПРАВА ЗАЩИЩЕНЫ`,menu:[`АУДИО`,`ВИДЕО`,`ГОСТЕВАЯ КНИГА`,`ВИЗУАЛ`,`СОЦСЕТИ`,`РЕЛИЗЫ`,`ФОТО`,`О ПРОЕКТЕ`],audio:`АУДИО`,tracks:`ТРЕКИ`,guest:`ГОСТЕВАЯ КНИГА`,soon:`СКОРО ОТКРЫТИЕ.

ГОСТЕВАЯ КНИГА СЕЙЧАС ГОТОВИТСЯ.
СКОРО ВЫ СМОЖЕТЕ ОСТАВИТЬ ЗДЕСЬ СВОЙ СЛЕД.`,releases:`РЕЛИЗЫ`,none:`РЕЛИЗОВ ПОКА НЕТ.

НОВАЯ МУЗЫКА УЖЕ СКОРО.`,connect:`СВЯЗАТЬСЯ С NYXTRYP`,mobile:`МОБИЛЬНАЯ / ПЛАНШЕТНАЯ ВЕРСИЯ`,light:`ВЫ ИЗУЧАЕТЕ ЛЁГКУЮ ВЕРСИЮ`,awaits:`ВСЕЛЕННАЯ
ЖДЁТ.`,visual:[`ЭТО ЛЁГКАЯ ВЕРСИЯ NYXTRYP ДЛЯ МОБИЛЬНЫХ УСТРОЙСТВ И ПЛАНШЕТОВ — СОЗДАННАЯ ДЛЯ БЫСТРОГО, ЧИСТОГО И АТМОСФЕРНОГО ОПЫТА НА НЕБОЛЬШИХ ЭКРАНАХ.`,`ОТКРОЙТЕ NYXTRYP НА КОМПЬЮТЕРЕ — И ВЫ УВИДИТЕ ДРУГУЮ СТОРОНУ ЭТОГО МИРА: ЖИВОЙ ЦИФРОВОЙ КОСМОС, ГДЕ САЙТ ПРЕВРАЩАЕТСЯ В ТРЁХМЕРНУЮ ВСЕЛЕННУЮ С ПРОСТРАНСТВОМ, ПЛАНЕТАМИ, ДВИЖЕНИЕМ И ИССЛЕДОВАНИЕМ.`,`DESKTOP-ВЕРСИЯ — ЭТО НЕ ПРОСТО ДРУГОЙ МАКЕТ. ЭТО ПОЛНЫЙ ОПЫТ NYXTRYP — ЖИВОЕ ПРОСТРАНСТВО, СОЗДАННОЕ ДЛЯ ИССЛЕДОВАНИЯ.`],about:`НЕЗАВИСИМЫЙ ПРОЕКТ ЭЛЕКТРОННОЙ МУЗЫКИ, ПОСТРОЕННЫЙ ВОКРУГ АТМОСФЕРЫ, ДВИЖЕНИЯ И ПОГРУЖЕНИЯ.

ЗВУК ДВИЖЕТСЯ МЕЖДУ ТРАНСОМ, ПСАЙТРАНСОМ, ГЛУБОКОЙ И ОРГАНИЧНОЙ ЭЛЕКТРОННОЙ МУЗЫКОЙ — ИССЛЕДУЯ ГИПНОТИЧЕСКИЕ РИТМЫ, РАЗВИВАЮЩИЕСЯ ТЕКСТУРЫ И ЭМОЦИОНАЛЬНОЕ ПРОСТРАНСТВО.

ВОЙДИТЕ В МИР. ИССЛЕДУЙТЕ.`},en:{project:`INDEPENDENT ELECTRONIC PROJECT`,tag:`ENTER THE UNKNOWN.`,note:`OPEN THE WEB VERSION. ENTER THE UNIVERSE.`,enter:`ENTER`,meta:`ELECTRONIC / IMMERSIVE`,world:`NYXTRYP / WORLD`,genres:`TRANCE · PSYTRANCE · ATMOSPHERE · MOTION`,footer:`OPEN THE WEB VERSION / DESKTOP UNIVERSE`,headerInfo:`THE FULL VERSION OF THE SITE IS AVAILABLE ONLY ON A COMPUTER OR LAPTOP · WITH RESPECT, NYXTRYP`,bottomInfo:`THIS WORLD IS MADE FOR THOSE WHO LOVE TO LISTEN, WATCH AND EXPLORE.`,copyright:`© 2026 NYXTRYP MUSIC · ALL RIGHTS RESERVED`,menu:[`AUDIO`,`VIDEO`,`GUESTBOOK`,`VISUAL`,`SOCIAL`,`RELEASES`,`PHOTOS`,`ABOUT`],audio:`AUDIO`,tracks:`TRACKS`,guest:`GUESTBOOK`,soon:`COMING SOON.

THE GUESTBOOK IS CURRENTLY BEING PREPARED.
LEAVE YOUR TRACE HERE SOON.`,releases:`RELEASES`,none:`NO RELEASES YET.

NEW MUSIC IS COMING.`,connect:`CONNECT WITH NYXTRYP`,mobile:`MOBILE / TABLET VERSION`,light:`YOU ARE EXPLORING THE LIGHT VERSION`,awaits:`THE UNIVERSE
AWAITS.`,visual:[`THIS IS THE LIGHTWEIGHT MOBILE AND TABLET VERSION OF NYXTRYP — DESIGNED FOR A FAST, CLEAN AND IMMERSIVE EXPERIENCE ON SMALLER SCREENS.`,`OPEN NYXTRYP FROM A COMPUTER AND YOU WILL ENTER A DIFFERENT SIDE OF THE WORLD: A LIVING DIGITAL COSMOS, WHERE THE SITE BECOMES A THREE-DIMENSIONAL UNIVERSE WITH SPACE, PLANETS, MOTION AND EXPLORATION.`,`THE DESKTOP VERSION IS NOT JUST ANOTHER LAYOUT. IT IS THE FULL NYXTRYP EXPERIENCE — A LIVING SPACE BUILT TO BE EXPLORED.`],about:`AN INDEPENDENT ELECTRONIC MUSIC PROJECT BUILT AROUND ATMOSPHERE, MOTION AND IMMERSION.

THE SOUND MOVES BETWEEN TRANCE, PSYTRANCE, DEEP AND ORGANIC ELECTRONIC MUSIC — EXPLORING HYPNOTIC RHYTHMS, EVOLVING TEXTURES AND EMOTIONAL SPACE.

ENTER THE WORLD. EXPLORE.`},de:{project:`UNABHÄNGIGES ELEKTRONISCHES PROJEKT`,tag:`BETRITT DAS UNBEKANNTE.`,note:`ÖFFNE DIE WEBVERSION. BETRITT DAS UNIVERSUM.`,enter:`EINTRETEN`,meta:`ELEKTRONIK / IMMERSION`,world:`NYXTRYP / WELT`,genres:`TRANCE · PSYTRANCE · ATMOSPHÄRE · BEWEGUNG`,footer:`WEBVERSION ÖFFNEN / DESKTOP-UNIVERSUM`,headerInfo:`DIE VOLLSTÄNDIGE VERSION DER WEBSITE IST NUR AUF EINEM COMPUTER ODER LAPTOP VERFÜGBAR · MIT RESPEKT, NYXTRYP`,bottomInfo:`DIESE WELT IST FÜR ALLE GESCHAFFEN, DIE GERNE HÖREN, SEHEN UND ENTDECKEN.`,copyright:`© 2026 NYXTRYP MUSIC · ALLE RECHTE VORBEHALTEN`,menu:[`AUDIO`,`VIDEO`,`GÄSTEBUCH`,`VISUAL`,`SOCIAL`,`RELEASES`,`FOTOS`,`ÜBER DAS PROJEKT`],audio:`AUDIO`,tracks:`TRACKS`,guest:`GÄSTEBUCH`,soon:`KOMMT BALD.

DAS GÄSTEBUCH WIRD DERZEIT VORBEREITET.
HINTERLASSE BALD DEINE SPUR.`,releases:`RELEASES`,none:`NOCH KEINE RELEASES.

NEUE MUSIK KOMMT BALD.`,connect:`MIT NYXTRYP VERBINDEN`,mobile:`MOBIL / TABLET VERSION`,light:`DU ERKUNDEST DIE LIGHT-VERSION`,awaits:`DAS UNIVERSUM
WARTET.`,visual:[`DIES IST DIE LEICHTE MOBILE- UND TABLET-VERSION VON NYXTRYP — ENTWICKELT FÜR EIN SCHNELLES, KLARES UND IMMERSIVES ERLEBNIS AUF KLEINEREN BILDSCHIRMEN.`,`ÖFFNE NYXTRYP AUF EINEM COMPUTER UND DU BETRITTST EINE ANDERE SEITE DER WELT: EINEN LEBENDIGEN DIGITALEN KOSMOS, IN DEM DIE WEBSITE ZU EINEM DREIDIMENSIONALEN UNIVERSUM MIT RAUM, PLANETEN, BEWEGUNG UND ENTDECKUNG WIRD.`,`DIE DESKTOP-VERSION IST NICHT NUR EIN ANDERES LAYOUT. SIE IST DAS VOLLE NYXTRYP-ERLEBNIS — EIN LEBENDIGER RAUM ZUM ERKUNDEN.`],about:`EIN UNABHÄNGIGES ELEKTRONISCHES MUSIKPROJEKT, AUFGEBAUT RUND UM ATMOSPHÄRE, BEWEGUNG UND IMMERSION.

DER SOUND BEWEGT SICH ZWISCHEN TRANCE, PSYTRANCE, TIEFER UND ORGANISCHER ELEKTRONISCHER MUSIK.`},fr:{project:`PROJET ÉLECTRONIQUE INDÉPENDANT`,tag:`ENTRE DANS L’INCONNU.`,note:`OUVRE LA VERSION WEB. ENTRE DANS L'UNIVERS.`,enter:`ENTRER`,meta:`ÉLECTRONIQUE / IMMERSION`,world:`NYXTRYP / MONDE`,genres:`TRANCE · PSYTRANCE · ATMOSPHÈRE · MOUVEMENT`,footer:`OUVRIR LA VERSION WEB / UNIVERS DESKTOP`,headerInfo:`LA VERSION COMPLÈTE DU SITE EST DISPONIBLE UNIQUEMENT SUR UN ORDINATEUR OU UN ORDINATEUR PORTABLE · AVEC RESPECT, NYXTRYP`,bottomInfo:`CE MONDE EST CRÉÉ POUR CEUX QUI AIMENT ÉCOUTER, REGARDER ET EXPLORER.`,copyright:`© 2026 NYXTRYP MUSIC · TOUS DROITS RÉSERVÉS`,menu:[`AUDIO`,`VIDÉO`,`LIVRE D'OR`,`VISUEL`,`SOCIAL`,`SORTIES`,`PHOTOS`,`À PROPOS`],audio:`AUDIO`,tracks:`TITRES`,guest:`LIVRE D'OR`,soon:`BIENTÔT DISPONIBLE.

LE LIVRE D'OR EST EN PRÉPARATION.
LAISSE BIENTÔT TA TRACE ICI.`,releases:`SORTIES`,none:`AUCUNE SORTIE POUR LE MOMENT.

DE LA NOUVELLE MUSIQUE ARRIVE.`,connect:`CONTACTER NYXTRYP`,mobile:`VERSION MOBILE / TABLETTE`,light:`VOUS EXPLOREZ LA VERSION LÉGÈRE`,awaits:`L'UNIVERS
ATTEND.`,visual:[`VOICI LA VERSION LÉGÈRE DE NYXTRYP POUR MOBILE ET TABLETTE — CONÇUE POUR UNE EXPÉRIENCE RAPIDE, PURE ET IMMERSIVE SUR LES PETITS ÉCRANS.`,`OUVRE NYXTRYP SUR UN ORDINATEUR ET TU DÉCOUVRIRAS UNE AUTRE FACE DU MONDE : UN COSMOS NUMÉRIQUE VIVANT OÙ LE SITE DEVIENT UN UNIVERS EN TROIS DIMENSIONS.`,`LA VERSION DESKTOP N'EST PAS SIMPLEMENT UNE AUTRE MISE EN PAGE. C'EST L'EXPÉRIENCE NYXTRYP COMPLÈTE.`],about:`UN PROJET DE MUSIQUE ÉLECTRONIQUE INDÉPENDANT CONSTRUIT AUTOUR DE L'ATMOSPHÈRE, DU MOUVEMENT ET DE L'IMMERSION.

LE SON ÉVOLUE ENTRE TRANCE, PSYTRANCE ET MUSIQUE ÉLECTRONIQUE ORGANIQUE.`}};function yu({title:e}){return(0,x.jsx)(`span`,{className:`light-row-icon icon-`+e.toLowerCase(),children:{AUDIO:`🎛️`,VIDEO:`▶️`,GUESTBOOK:`📖`,VISUAL:`🌌`,SOCIAL:`🔗`,RELEASES:`💿`,PHOTOS:`📷`,ABOUT:`💬`}[e]})}function bu({children:e,onClose:t}){return(0,x.jsxs)(`div`,{className:`light-modal`,onPointerDown:e=>e.target===e.currentTarget&&t(),children:[(0,x.jsx)(`button`,{className:`light-close`,onClick:t,children:`×`}),(0,x.jsx)(`div`,{className:`light-modal-content`,children:e})]})}function xu(){let[e,t]=(0,b.useState)(!1),[n,r]=(0,b.useState)(null),[i,a]=(0,b.useState)(null),[o,s]=(0,b.useState)(`en`),c=vu[o];(0,b.useEffect)(()=>{let e=document.body.style.overflow,t=document.documentElement.style.overflow;return document.body.style.overflow=`auto`,document.documentElement.style.overflow=`auto`,()=>{document.body.style.overflow=e,document.documentElement.style.overflow=t}},[]);let l=()=>(0,x.jsxs)(`div`,{className:`light-flags`,children:[(0,x.jsx)(`button`,{onClick:()=>s(`ru`),"aria-label":`Русский`,children:`🇷🇺`}),(0,x.jsx)(`button`,{onClick:()=>s(`en`),"aria-label":`English`,children:`🇬🇧`}),(0,x.jsx)(`button`,{onClick:()=>s(`de`),"aria-label":`Deutsch`,children:`🇩🇪`}),(0,x.jsx)(`button`,{onClick:()=>s(`fr`),"aria-label":`Français`,children:`🇫🇷`})]}),u=e=>e===`photos`?hu():a(e),d=e=>e===`AUDIO`?`audio`:e===`VIDEO`?`video`:e.toLowerCase();return e?(0,x.jsxs)(`main`,{className:`light-site light-home`,children:[(0,x.jsx)(`div`,{className:`light-stars`}),(0,x.jsxs)(`header`,{className:`light-header`,children:[(0,x.jsx)(`button`,{className:`light-brand`,onClick:()=>a(null),children:`NYXTRYP`}),(0,x.jsx)(`div`,{className:`light-header-meta`,"data-header-info":c.headerInfo,children:c.meta}),(0,x.jsx)(l,{})]}),(0,x.jsxs)(`section`,{className:`light-hero`,children:[(0,x.jsx)(`div`,{className:`light-hero-line`,children:c.world}),(0,x.jsx)(`h1`,{className:`light-home-tag`,children:c.tag}),(0,x.jsx)(`p`,{children:c.genres})]}),(0,x.jsx)(`nav`,{className:`light-list`,children:_u.map(([e,t],n)=>(0,x.jsxs)(`button`,{className:`light-row `+(e===`01`?`is-featured`:``),onClick:()=>u(d(t)),children:[(0,x.jsx)(`span`,{className:`light-row-number`,children:e}),(0,x.jsx)(`span`,{className:`light-row-title`,children:c.menu[n]}),(0,x.jsx)(yu,{title:t})]},t))}),(0,x.jsxs)(`footer`,{className:`light-footer`,"data-bottom-info":c.bottomInfo,children:[(0,x.jsx)(`span`,{children:`NYXTRYP`}),(0,x.jsx)(`span`,{children:c.footer}),(0,x.jsx)(`span`,{className:`light-copyright`,children:c.copyright})]}),i===`audio`&&(0,x.jsx)(bu,{onClose:()=>a(null),children:(0,x.jsxs)(`div`,{className:`light-index`,children:[(0,x.jsx)(`div`,{className:`light-modal-kicker`,children:c.audio}),(0,x.jsx)(`button`,{onClick:()=>r(`tracks`),children:(0,x.jsx)(`strong`,{children:c.tracks})}),(0,x.jsx)(`button`,{onClick:()=>r(`radio`),children:(0,x.jsx)(`strong`,{children:`RADIO`})}),(0,x.jsx)(`button`,{onClick:()=>r(`mixes`),children:(0,x.jsx)(`strong`,{children:`MIXES`})})]})}),i===`video`&&(0,x.jsx)(bu,{onClose:()=>a(null),children:(0,x.jsxs)(`div`,{className:`light-index`,children:[(0,x.jsx)(`div`,{className:`light-modal-kicker`,children:c.menu[1]}),(0,x.jsx)(`a`,{className:`light-modal-link`,href:`https://www.youtube.com/@nyxtryp`,target:`_blank`,rel:`noopener noreferrer`,children:(0,x.jsx)(`strong`,{children:`YOUTUBE`})})]})}),i===`guestbook`&&(0,x.jsx)(bu,{onClose:()=>a(null),children:(0,x.jsx)(Su,{kicker:c.world,title:c.guest,text:c.soon})}),i===`releases`&&(0,x.jsx)(bu,{onClose:()=>a(null),children:(0,x.jsx)(Su,{kicker:`NYXTRYP / MUSIC`,title:c.releases,text:c.none})}),i===`about`&&(0,x.jsx)(bu,{onClose:()=>a(null),children:(0,x.jsx)(Su,{kicker:`NYXTRYP / ABOUT`,title:`NYXTRYP`,text:c.about})}),i===`social`&&(0,x.jsx)(bu,{onClose:()=>a(null),children:(0,x.jsxs)(`div`,{className:`light-index`,children:[(0,x.jsx)(`div`,{className:`light-modal-kicker`,children:c.connect}),gu.map(([e,t])=>(0,x.jsx)(`a`,{className:`light-modal-link`,href:t,target:`_blank`,rel:`noopener noreferrer`,children:(0,x.jsx)(`strong`,{children:e})},e))]})}),i===`visual`&&(0,x.jsx)(bu,{onClose:()=>a(null),children:(0,x.jsxs)(`div`,{className:`light-visual-page`,children:[(0,x.jsx)(`div`,{className:`light-modal-kicker`,children:c.mobile}),(0,x.jsxs)(`div`,{className:`light-visual-message`,children:[(0,x.jsx)(`div`,{className:`light-visual-eyebrow`,children:c.light}),(0,x.jsx)(`h2`,{children:c.awaits.split(`
`).map((e,t)=>(0,x.jsxs)(x.Fragment,{children:[t>0&&(0,x.jsx)(`br`,{}),t===1?(0,x.jsx)(`em`,{children:e}):e]}))}),(0,x.jsx)(`div`,{className:`light-visual-rule`}),c.visual.map(e=>(0,x.jsx)(`p`,{children:e},e)),(0,x.jsx)(`div`,{className:`light-visual-sign`,children:`NYXTRYP / DESKTOP UNIVERSE`})]})]})}),n===`tracks`&&(0,x.jsx)(bu,{onClose:()=>r(null),children:(0,x.jsx)(au,{onClose:()=>r(null)})}),n===`radio`&&(0,x.jsx)(bu,{onClose:()=>r(null),children:(0,x.jsx)(Zl,{onClose:()=>r(null)})}),n===`mixes`&&(0,x.jsx)(bu,{onClose:()=>r(null),children:(0,x.jsx)(eu,{onClose:()=>r(null)})})]}):(0,x.jsxs)(`main`,{className:`light-site light-intro`,children:[(0,x.jsx)(l,{}),(0,x.jsx)(`div`,{className:`light-noise`}),(0,x.jsx)(`div`,{className:`light-orbit orbit-a`}),(0,x.jsx)(`div`,{className:`light-orbit orbit-b`}),(0,x.jsxs)(`div`,{className:`light-intro-core`,children:[(0,x.jsx)(`div`,{className:`light-kicker`,children:c.project}),(0,x.jsx)(`div`,{className:`light-logo`,children:`NYXTRYP`}),(0,x.jsx)(`div`,{className:`light-tag`,children:c.tag}),(0,x.jsx)(`div`,{className:`light-note`,children:c.note}),(0,x.jsxs)(`button`,{className:`light-enter`,onClick:()=>t(!0),children:[(0,x.jsx)(`span`,{children:c.enter}),(0,x.jsx)(`i`,{children:`↗`})]})]})]})}function Su({kicker:e,title:t,text:n}){return(0,x.jsxs)(`div`,{className:`light-simple`,children:[(0,x.jsx)(`div`,{className:`light-modal-kicker`,children:e}),(0,x.jsx)(`h2`,{children:t}),(0,x.jsx)(`div`,{className:`light-rule`}),(0,x.jsx)(`p`,{children:n})]})}function Cu(){if(window.location.pathname===`/admin`)return(0,x.jsx)(fu,{});let e=Math.min(window.innerWidth,window.innerHeight)<=1100,t=navigator.maxTouchPoints>0;return(0,x.jsx)(`main`,{className:`nyxtryp`,children:e&&t?(0,x.jsx)(xu,{}):(0,x.jsx)(ou,{})})}var wu=document.createElement.bind(document);document.createElement=function(e,t){let n=wu(e,t);return String(e).toLowerCase()===`audio`&&(n.crossOrigin=`anonymous`),n},y.createRoot(document.getElementById(`root`)).render((0,x.jsx)(b.StrictMode,{children:(0,x.jsx)(Cu,{})}));